...
Version 2.4 -- Supports vehicles, which were introduced in sheet version 4.42. Vehicle characters have special power sections for up to two endurance reserves and two propulsion systems, which increases imported powers up to 24. While the base capacity for general powers remains twenty, up to thirty more will be imported and displayed in the Talents text box (requires HeroSystem6eHeroic.hde v2.4). Introduces the Size attribute. Supports the expanded general and combat skill capacities of the sheet (February 21, 2025).
