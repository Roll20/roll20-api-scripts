...
var groupCheck = groupCheck || (function() {
	...
	importData = {
		'5E-Shaped' : {
			'Strength Save': { 'name' : 'Strength Saving Throw', 'formula' : '[[d20 + %strength_mod% + %strength_save_prof% + %strength_save_bonus%	+ %global_saving_throw_bonus%]]' },
			'Dexterity Save': { 'name' : 'Dexterity Saving Throw', 'formula' : '[[d20 + %dexterity_mod% + %dexterity_save_prof% + %dexterity_save_bonus%	+ %global_saving_throw_bonus%]]' },
			'Constitution Save': { 'name' : 'Constitution Saving Throw', 'formula' : '[[d20 + %constitution_mod% + %constitution_save_prof% + %constitution_save_bonus%	+ %global_saving_throw_bonus%]]' },
			'Intelligence Save': { 'name' : 'Intelligence Saving Throw', 'formula' : '[[d20 + %intelligence_mod% + %intelligence_save_prof% + %intelligence_save_bonus%	+ %global_saving_throw_bonus%]]' },
			'Wisdom Save': { 'name' : 'Wisdom Saving Throw', 'formula' : '[[d20 + %wisdom_mod% + %wisdom_save_prof% + %wisdom_save_bonus%	+ %global_saving_throw_bonus%]]' },
			'Charisma Save': { 'name' : 'Charisma Saving Throw', 'formula' : '[[d20 + %charisma_mod% + %charisma_save_prof% + %charisma_save_bonus%	+ %global_saving_throw_bonus%]]' },
...
//			'Will Save': { 'name' : 'Will Saving Throw', 'formula' : '[[d20 + %will_saving_throw_mod%]]' },
	...
	printHelp = function(whisper) {
		let helpString = whisper + '<div style="border:1px solid black;' +
			...
			'roll20-api-scripts/tree/master/GroupCheck/1.3/README.md">documentation' +
