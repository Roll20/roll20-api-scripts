...
var groupCheck = groupCheck || (function() {
	...
	importData = {
		'5E-Shaped' : {
			'Strength Save': { 'name' : 'Strength Saving Throw', 'formula' : '[[d20  + %strength_mod%[mod] + %strength_saving_throw_proficient%*%pb%[prof] + %strength_saving_throw_bonus%[bonus] + %global_saving_throw_bonus%[global]]]' },
			'Dexterity Save': { 'name' : 'Dexterity Saving Throw', 'formula' : '[[d20  + %dexterity_mod%[mod] + %dexterity_saving_throw_proficient%*%pb%[prof] + %dexterity_saving_throw_bonus%[bonus] + %global_saving_throw_bonus%[global]]]' },
			'Constitution Save': { 'name' : 'Constitution Saving Throw', 'formula' : '[[d20  + %constitution_mod%[mod] + %constitution_saving_throw_proficient%*%pb%[prof] + %constitution_saving_throw_bonus%[bonus] + %global_saving_throw_bonus%[global]]]' },
			'Intelligence Save': { 'name' : 'Intelligence Saving Throw', 'formula' : '[[d20  + %intelligence_mod%[mod] + %intelligence_saving_throw_proficient%*%pb%[prof] + %intelligence_saving_throw_bonus%[bonus] + %global_saving_throw_bonus%[global]]]' },
			'Wisdom Save': { 'name' : 'Wisdom Saving Throw', 'formula' : '[[d20  + %wisdom_mod%[mod] + %wisdom_saving_throw_proficient%*%pb%[prof] + %wisdom_saving_throw_bonus%[bonus] + %global_saving_throw_bonus%[global]]]' },
			'Charisma Save': { 'name' : 'Charisma Saving Throw', 'formula' : '[[d20  + %charisma_mod%[mod] + %charisma_saving_throw_proficient%*%pb%[prof] + %charisma_saving_throw_bonus%[bonus] + %global_saving_throw_bonus%[global]]]' },
			'Strength Check': { 'name' : 'Strength Check', 'formula' : '[[d20 %strength_check_mod_with_sign%]]' },
			'Dexterity Check': { 'name' : 'Dexterity Check', 'formula' : '[[d20 %dexterity_check_mod_with_sign%]]' },
			'Constitution Check': { 'name' : 'Constitution Check', 'formula' : '[[d20 %constitution_check_mod_with_sign%]]' },
			'Intelligence Check': { 'name' : 'Intelligence Check', 'formula' : '[[d20 %intelligence_check_mod_with_sign%]]' },
			'Wisdom Check': { 'name' : 'Wisdom Check', 'formula' : '[[d20 %wisdom_check_mod_with_sign%]]' },
			'Charisma Check': { 'name' : 'Charisma Check', 'formula' : '[[d20 %charisma_check_mod_with_sign%]]' },
			'Acrobatics': { 'name' : 'Dexterity (Acrobatics) Check', 'formula' : '[[d20 %repeating_skill_$0_total_with_sign%]]' },
			'Animal Handling': { 'name' : 'Wisdom (Animal Handling) Check', 'formula' : '[[d20 %repeating_skill_$1_total_with_sign%]]' },
			'Arcana': { 'name' : 'Intelligence (Arcana) Check', 'formula' : '[[d20 %repeating_skill_$2_total_with_sign%]]' },
			'Athletics': { 'name' : 'Strength (Athletics) Check', 'formula' : '[[d20 %repeating_skill_$3_total_with_sign%]]' },
			'Deception': { 'name' : 'Charisma (Deception) Check', 'formula' : '[[d20 %repeating_skill_$4_total_with_sign%]]' },
			'History': { 'name' : 'Intelligence (History) Check', 'formula' : '[[d20 %repeating_skill_$5_total_with_sign%]]' },
			'Insight': { 'name' : 'Wisdom (Insight) Check', 'formula' : '[[d20 %repeating_skill_$6_total_with_sign%]]' },
			'Intimidation': { 'name' : 'Charisma (Intimidation) Check', 'formula' : '[[d20 %repeating_skill_$7_total_with_sign%]]' },
			'Investigation': { 'name' : 'Intelligence (Investigation) Check', 'formula' : '[[d20 %repeating_skill_$8_total_with_sign%]]' },
			'Medicine': { 'name' : 'Wisdom (Medicine) Check', 'formula' : '[[d20 %repeating_skill_$9_total_with_sign%]]' },
			'Nature': { 'name' : 'Intelligence (Nature) Check', 'formula' : '[[d20 %repeating_skill_$10_total_with_sign%]]' },
			'Perception': { 'name' : 'Wisdom (Perception) Check', 'formula' : '[[d20 %repeating_skill_$11_total_with_sign%]]' },
			'Performance': { 'name' : 'Charisma (Performance) Check', 'formula' : '[[d20 %repeating_skill_$12_total_with_sign%]]' },
			'Persuasion': { 'name' : 'Charisma (Persuasion) Check', 'formula' : '[[d20 %repeating_skill_$13_total_with_sign%]]' },
			'Religion': { 'name' : 'Intelligence (Religion) Check', 'formula' : '[[d20 %repeating_skill_$14_total_with_sign%]]' },
			'Sleight of Hand': { 'name' : 'Dexterity (Sleight of Hand) Check', 'formula' : '[[d20 %repeating_skill_$15_total_with_sign%]]' },
			'Stealth': { 'name' : 'Dexterity (Stealth) Check', 'formula' : '[[d20 %repeating_skill_$16_total_with_sign%]]' },
			'Survival': { 'name' : 'Wisdom (Survival) Check', 'formula' : '[[d20 %repeating_skill_$17_total_with_sign%]]' },
	...
	printHelp = function(whisper) {
		let helpString = whisper + '<div style="border:1px solid black;' +
			...
			'roll20-api-scripts/tree/master/GroupCheck/1.3.2/README.md">documentation' +
