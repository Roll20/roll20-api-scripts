...
var groupCheck = groupCheck || (function() {
	...
	importData = {
		'5E-Shaped' : {
			'Strength Save': { name: 'Strength Saving Throw', formula: '[[d20  + %strength_saving_throw_formula%]]', special: 'shaped'},
			'Dexterity Save': { name: 'Dexterity Saving Throw', formula: '[[d20  + %dexterity_saving_throw_formula%]]', special: 'shaped'},
			'Constitution Save': { name: 'Constitution Saving Throw', formula: '[[d20  + %constitution_saving_throw_formula%]]', special: 'shaped'},
			'Intelligence Save': { name: 'Intelligence Saving Throw', formula: '[[d20  + %intelligence_saving_throw_formula%]]', special: 'shaped'},
			'Wisdom Save': { name: 'Wisdom Saving Throw', formula: '[[d20  + %wisdom_saving_throw_formula%]]', special: 'shaped'},
			'Charisma Save': { name: 'Charisma Saving Throw', formula: '[[d20  + %charisma_saving_throw_formula%]]', special: 'shaped'},
			'Strength Check': { name: 'Strength Check', formula: '[[d20 + %strength_check_formula%]]', special: 'shaped'},
			'Dexterity Check': { name: 'Dexterity Check', formula: '[[d20 + %dexterity_check_formula%]]', special: 'shaped'},
			'Constitution Check': { name: 'Constitution Check', formula: '[[d20 + %constitution_check_formula%]]', special: 'shaped'},
			'Intelligence Check': { name: 'Intelligence Check', formula: '[[d20 + %intelligence_check_formula%]]', special: 'shaped'},
			'Wisdom Check': { name: 'Wisdom Check', formula: '[[d20 + %wisdom_check_formula%]]', special: 'shaped'},
			'Charisma Check': { name: 'Charisma Check', formula: '[[d20 + %charisma_check_formula%]]', special: 'shaped'},
			'Acrobatics': { name: 'Dexterity (Acrobatics) Check', formula: '[[d20 + %repeating_skill_$0_formula%]]', special: 'shaped'},
			'Animal Handling': { name: 'Wisdom (Animal Handling) Check', formula: '[[d20 + %repeating_skill_$1_formula%]]', special: 'shaped'},
			'Arcana': { name: 'Intelligence (Arcana) Check', formula: '[[d20 + %repeating_skill_$2_formula%]]', special: 'shaped'},
			'Athletics': { name: 'Strength (Athletics) Check', formula: '[[d20 + %repeating_skill_$3_formula%]]', special: 'shaped'},
			'Deception': { name: 'Charisma (Deception) Check', formula: '[[d20 + %repeating_skill_$4_formula%]]', special: 'shaped'},
			'History': { name: 'Intelligence (History) Check', formula: '[[d20 + %repeating_skill_$5_formula%]]', special: 'shaped'},
			'Insight': { name: 'Wisdom (Insight) Check', formula: '[[d20 + %repeating_skill_$6_formula%]]', special: 'shaped'},
			'Intimidation': { name: 'Charisma (Intimidation) Check', formula: '[[d20 + %repeating_skill_$7_formula%]]', special: 'shaped'},
			'Investigation': { name: 'Intelligence (Investigation) Check', formula: '[[d20 + %repeating_skill_$8_formula%]]', special: 'shaped'},
			'Medicine': { name: 'Wisdom (Medicine) Check', formula: '[[d20 + %repeating_skill_$9_formula%]]', special: 'shaped'},
			'Nature': { name: 'Intelligence (Nature) Check', formula: '[[d20 + %repeating_skill_$10_formula%]]', special: 'shaped'},
			'Perception': { name: 'Wisdom (Perception) Check', formula: '[[d20 + %repeating_skill_$11_formula%]]', special: 'shaped'},
			'Performance': { name: 'Charisma (Performance) Check', formula: '[[d20 + %repeating_skill_$12_formula%]]', special: 'shaped'},
			'Persuasion': { name: 'Charisma (Persuasion) Check', formula: '[[d20 + %repeating_skill_$13_formula%]]', special: 'shaped'},
			'Religion': { name: 'Intelligence (Religion) Check', formula: '[[d20 + %repeating_skill_$14_formula%]]', special: 'shaped'},
			'Sleight of Hand': { name: 'Dexterity (Sleight of Hand) Check', formula: '[[d20 + %repeating_skill_$15_formula%]]', special: 'shaped'},
			'Stealth': { name: 'Dexterity (Stealth) Check', formula: '[[d20 + %repeating_skill_$16_formula%]]', special: 'shaped'},
			'Survival': { name: 'Wisdom (Survival) Check', formula: '[[d20 + %repeating_skill_$17_formula%]]', special: 'shaped'},
	...
	processFormula = function (formula, special, charID, charName) {
		if (special === 'shaped') {
			...
			return formula.replace('{{@{shaped_d20}=1}} {{roll1=[[@{shaped_d20}@{d20_mod} + ', '')
				.replace(']]}}', '');
		} else {
