...
'<div style="border: 1px solid black; background-color: white; padding: 3px 3px;">'+
	...
	'<div style="padding-left:10px;">'+
		...
		'</div>'+
		'<b><span style="font-family: serif;">--silent</span></b>'+
		'<div style="padding-left: 10px;padding-right:20px">'+
			'Suppress the success message after ammo is adjusted.  Warnings (not enough ammo, missing attribute, permission) are still shown.  Combine with --allow-partial to deplete ammo with no chat output at all.'+
		'</div>'+
	'</div>'+
'</div>'
            );
