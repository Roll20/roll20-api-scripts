    ...
    */
    ...
    generateHelp = function(){
        ...
        gmHelp = '<div style="border: 2px solid black; background-color: white; padding: 3px 3px;">'
            ...
            +'<ul>'
            +'&'+'#8226'+'; <b><span style="font-family: serif;">volume - </span></b>What to set the volume to. This can be a number, or an expression. Valid expressions are -X,+X,/X,and *X.<br>'
            ...
            +'&'+'#8226'+'; <b><span style="font-family: serif;">mute/unmute - </span></b>Sets the jukebox volume of the indicated track(s) to 0, but does not affect the saved track volume/restores the volume of the indicated track(s) to their saved volume.<br>'
    ...
    delayHandler = function(cmdDetails,tracks,playlists,playerid){
        ...
        switch(cmdDetails.action){
            //Roll Listener Creation
            //syntax:
            //!roll20AM --createListen,name:NAME,[template:TEMPLATE],surround:$$,roll:Critical--actionGroup to activate--actionGroup to activate
            //$$ denotes where the roll can be found in the surrounding text
            case 'createListen':
	...
	cmdExtract = function(cmd){
	    ...
	    cmdSep.action = details.match(/play|stop|vcontrol|config|listCreate|listEdit|cancelDelay|set/)[0];
