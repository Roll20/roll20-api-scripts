    ...
    var critRoll = function (addCritNum) {
        ...
        for (var key in critTable) {
            ...
            if ((rollTotal >= low) && (rollTotal <= high)) {
                ...
                chat = chat + '{{flavor=<img style="margin-center:auto; margin-center:auto;" src="http://i.imgur.com/z51hRwd.png" />}}'
    ...
    var critRoll = function (addCritNum) {
        ...
        for (var key in critTable) {
            ...
            if ((rollTotal >= low) && (rollTotal <= high)) {
                ...
                chat = chat + '{{flavor=<img style="margin-center:auto;" src="http://i.imgur.com/JO3pOr8.png" />}}';//need new graphic
                chat = chat + '{{Current Criticals=' + totalcrits + ' x 10}}';
                if (rollOffset) {
                    chat = chat + '{{Dice Roll Offset=' + rollOffset + '}}';
                }
