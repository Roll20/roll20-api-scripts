...
on('ready', () => {
    ...
    on('chat:message', (msg_orig) => {
        ...
        const randomImageButton = "<a href = '"+msg.content.replace('!faces ','!faces images/random ') + "' style = 'display:inline-block; float:right; background-color:transparent; border:none; font-family: pictos; color:#ddd'>;</a>";
