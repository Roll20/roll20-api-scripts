...
on('chat:message', async (msg_orig) => {
    ...
    const helpLinks = new Proxy({
        ...
        helpCampaign: `If you want the name of the campaign to appear at the top of every report, put it in the gmnotes of the Campaign Survey Report handout. You may remove it manually by editing the handout normally.`,
        // For future use should marketplace library become available. helpCampaign: `If you want the name of the campaign to appear at the top of every report, put it in the gmnotes of the Campaign Survey Report handout. If you wish your Campaign Report to use the image of a module, press <a style ='background-color: transparent; padding: 0px; color: #ce0f69; display: inline-block;border: none' href ='!survey --makeheader'>this button</a> and the script will attempt to find the module's title image. You may remove it manually by editing the handout normally.`,
    ...
    if (!campaignTitle || campaignTitle === "null") {
