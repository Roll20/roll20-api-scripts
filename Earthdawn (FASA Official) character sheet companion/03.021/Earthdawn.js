...
Earthdawn.Version = "3.021";      // This is the version number of this API file.  state.Earthdawn.sheetVersion is the version number of the html file. 
...
//                  + "?{Distance Fallen|2-3 Yrd,2-3: 5|4-6 Yrd,4-6: 10|7-10 Yrd,7-10: 15|11-20 Yrd,11-20: 40|21-30 Yrd,21-30: 50|31-50 Yrd,31-50: 75"
//                  + "|51-100 Yrd,51-100: 90|101-150 Yrd,101-150: 120|151-200 Yrd,150-200: 140|201 Yrd or more,201 or more: 175}~ foreach: st~ Roll",
...
//                  + "11-20 Yrd,20 (2)|21-30 Yrd,25 (2)|31-50,25 (3)|51-100 Yrd,30 (3)|101-150 Yrd,30 (4)|151-200 Yrd,35 (4)|201 Yrd or more,35 (5)}: ",
//CDD ToDo Jan 23
    ...
    this.Damage = function( ssa ) {
      ...
      try {
        ...
        if( dmg <= 0 && !bRecovery )        // If the passed damage evaluates to zero, just exit.
          return;
        if( bStrain ) {     // Edge case. Strain should not have armor, but Take-Damage and Damage-Target buttons allows user to choose strain and an armor.
          armor = 0;
          armorType = "";
        }
        dmg -= armor;
...
//          step = Earthdawn.parseInt2(this.misc[ "step" ] || 0) + this.ssaMods( ssa );   // Add any mods to roll.
...
//                  this.setWW( "condition-KnockedDown", "1" );
            ...
            if( "AfterRoll" in po.misc ) {    // After the Roll, we might do something else with the result. 
              ...
              if( sub[ 1 ].trim() === "buttonDamageBoth" || sub[ 1 ].trim() === "buttonDamageTargeted" )    // AfterRoll: buttonDamageBoth: (type of damage PA/NA)
                po.misc[ "cButtons" ].push({
                    link: "!Earthdawn~ setToken: &#64;{target|Apply damage to which token|token_id}~ "
