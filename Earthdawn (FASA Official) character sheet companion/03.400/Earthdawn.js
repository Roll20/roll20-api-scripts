...
Earthdawn.Version = "3.4";       // This is the version number of this API file.
...
//        }
        if ( this.misc[ "natural" ] ) {   // A natural roll is one without a callback. It just goes out, and the raw results are returned.  Done for rolls without target numbers, and rolls that are sent to both player and gm, but not public.
          ...
          sendChat( "player|" + this.edClass.msg.playerid, "/r " + this.misc[ "dice" ], function( ops ) {
            'use strict';
                  // NOTE THAT THIS IS THE START OF A CALLBACK FUNCTION
            if( ops.length !== 1 )
...
//log( "BoD " + what + "   " + t);
        ...
        switch( ssa[ 2 ] ) {
          ...
          case "TuneGrimoire": {
            ...
            this.misc[ "endNoteSucc" ] = "Grimoire Successfully Attuned." + buttonOnDemand( "extra" ) + buttonOnDemand( "weave" ) + buttonOnDemand( "cast" );
