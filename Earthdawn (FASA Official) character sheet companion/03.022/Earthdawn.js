...
Earthdawn.Version = "3.022";      // This is the version number of this API file.  state.Earthdawn.sheetVersion is the version number of the html file. 
...
//                  class: "showtip tipsy",
        ...
        if( "eachTargets" in this )     // We compare the roll result to each target number in the list.
          for( let i = 0; i < this.eachTargets.length; ++i ) {
            ...
            body.append( (( ++linenum % 2) ? ".odd" : ".even"), "<b>" + this.eachTargets[ i ][ "tName" ] + "</b>  "
                  + (( state.Earthdawn.style === Earthdawn.style.Full || state.Earthdawn.style === Earthdawn.style.VagueSuccess) ? "TN# " + this.eachTargets[ i ][ "tNum" ] + ":" : "" )
                  + "  " + t );
          }
