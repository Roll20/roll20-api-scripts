...
var handleapicommand = function(msg,command,option) {
    ...
    sendChat(msg.who, "<div class='sheet-rolltemplate-simple'><div class='sheet-container'><div class='sheet-label' style='margin-top:5px;'><span style='display:block;'>" + command + ": " + state.FifthEditionOGLbyRoll20[command] + "</span></div></div></div>");
};
...
var outputstatus = function(msg) {
    ...
    sendChat(msg.who, "<div class='sheet-rolltemplate-simple'><div class='sheet-container'><div class='sheet-label' style='margin-top:5px;'><span style='display:block;'>ammotracking: " + ammotrackingstatus + "</span><span style='display:block;'>autonpctoken: " + autonpctokenstatus + "</span><span style='display:block;'>deathsavetracking: " + deathsavetrackingstatus + "</span><span style='display:block;'>spelltracking: " + spelltrackingstatus + "</span><span style='display:block; margin-top:5px;'>5th Edition OGL by Roll20</span></div></div></div>");
}

var outputhelp = function(msg) {
    sendChat(msg.who, "<div class='sheet-rolltemplate-simple'><div class='sheet-container'><div class='sheet-label' style='margin-top:5px;'><span style='display:block;'>!5estatus</span><span style='display:block;'>!ammotracking on/off/quiet</span><span style='display:block;'>!autonpctoken on/off</span><span style='display:block;'>!deathsavetracking on/off/quiet</span><span style='display:block;'>!spelltracking on/off/quiet</span><span style='display:block;'>!longrest \<character name\></span><span style='display:block; margin-top:5px;'>5th Edition OGL by Roll20</span></div></div></div>");    
}
...
var handledeathsave = function(msg,character) {
    ...
    if(state.FifthEditionOGLbyRoll20.deathsavetracking != "quiet") {
        if(getAttrByName(character.id, "wtype") === "") {
            ...
            sendChat(msg.who, "/w gm <div class='sheet-rolltemplate-simple'><div class='sheet-container'><div class='sheet-label' style='margin-top:5px;'><span>" + resultoutput + "</span></div></div></div>");
        }
    }
};
    ...
    if(spent <= parseInt(charslotmax.get("current"),10)) {
        if(state.FifthEditionOGLbyRoll20.spelltracking != "quiet") {
            if(getAttrByName(character.id, "wtype") === "") {
                ...
                sendChat(msg.who, "/w gm <div class='sheet-rolltemplate-simple'><div class='sheet-container'><div class='sheet-label' style='margin-top:5px;'><span>SPELL SLOT LEVEL " + spellslot + "</span><span style='display:block;'>" + spent + " OF " + charslotmax.get("current") + " EXPENDED</span></div></div></div>");
            }
        }
    }
    else {
        if(getAttrByName(character.id, "wtype") === "") {
            ...
            sendChat(msg.who, "/w gm <div class='sheet-rolltemplate-simple'><div class='sheet-container'><div class='sheet-label' style='margin-top:5px;'><span>SPELL SLOT LEVEL " + spellslot + "</span><span style='display:block; color:red;'>ALL SLOTS EXPENDED</span></div></div></div>");
        }
    }
}
    ...
    if(ammoresource) {
        ...
        if(ammoresource.get("current") < 0) {
            if(getAttrByName(character.id, "wtype") === "") {
                ...
                sendChat(msg.who, "/w gm <div class='sheet-rolltemplate-simple'><div class='sheet-container' style='border-radius: 0px;'><div class='sheet-label' style='margin-top:5px;'><span style='display:block; color:red;'>OUT OF AMMO</span></div></div></div>");
            }
        }
            ...
            if(getAttrByName(character.id, "wtype") === "") {
                ...
                sendChat(msg.who, "/w gm <div class='sheet-rolltemplate-simple'><div class='sheet-container' style='border-radius: 0px;'><div class='sheet-label' style='margin-top:5px;'><span style='display:block;'>" + ammoname + ": " + ammoresource.get("current") + " LEFT</span></div></div></div>");
            }
        }
    }
};
