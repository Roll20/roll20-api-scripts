...
export const mtaProfile = Object.freeze({
  ...
  CONDITION_DATA: Object.freeze({
    ...
    "Willpower Spent": { past: "willpower spent", verb: "drains willpower from", icon: "[WP]", emoji: "💧" },
    Ability: { past: "affected by a sphere effect", verb: "uses a sphere effect on", icon: "[Sph]", emoji: "🎯" },
  }),
