...
export const callOfCthulhuProfile = Object.freeze({
  ...
  CONDITION_DATA: Object.freeze({
    ...
    "Indefinite Insanity": { past: "indefinitely insane", verb: "drives", suffix: "indefinitely insane", icon: "[II]", emoji: "🤯" },
    Injured: { past: "injured", verb: "injures", icon: "[Inj]", emoji: "🩹" },
    Mania: { past: "gripped by mania", verb: "triggers mania in", icon: "[Man]", emoji: "😤" },
    Phobia: { past: "gripped by a phobia", verb: "triggers a phobia in", icon: "[Phb]", emoji: "😱" },
    "Seriously Wounded": { past: "seriously wounded", verb: "seriously wounds", icon: "[SW]", emoji: "🩸" },
    "Temporary Insanity": { past: "temporarily insane", verb: "drives", suffix: "temporarily insane", icon: "[TI]", emoji: "🌀" },
    ...
    Spell: { past: "affected by a mythos spell", verb: "casts a mythos spell on", icon: "[Spl]", emoji: "🔮" },
    Ability: { past: "affected by a skill effect", verb: "uses a skill on", icon: "[Skl]", emoji: "🎯" },
  }),
