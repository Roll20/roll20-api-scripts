...
export const thirteenthAgeProfile = Object.freeze({
  ...
  CONDITION_DATA: Object.freeze({
    ...
    "Ongoing Damage": { past: "taking ongoing damage", verb: "deals ongoing damage to", icon: "[OD]", emoji: "⚡" },
    Stunned: { past: "stunned", verb: "stuns", icon: "[Stn]", emoji: "😵" },
    Vulnerable: { past: "vulnerable", verb: "renders", suffix: "vulnerable", icon: "[Vuln]", emoji: "🛡️" },
