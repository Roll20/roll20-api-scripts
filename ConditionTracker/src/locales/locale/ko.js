const TRANSLATION = {
  ...
  ui: {
    ...
    msg: {
      ...
      unknownConfig: "알 수 없는 설정 옵션입니다. --config 를 사용하여 지원되는 설정을 확인하세요.",
      macroReinstalled: "{wizard}, {multiTarget}, {reportToken}, {saved} 및 {classify} 매크로가 모든 현재 GM 플레이어를 위해 재설치되었습니다.",
      ...
      reSelectTokens: "원래 선택한 토큰을 찾을 수 없습니다. 토큰을 다시 선택하고 다시 시도하세요.",
      ...
      subjectBypassInvalid: "--subjectPromptBypass 는 값이 제공될 때 true 또는 false를 기대합니다.",
      customDetailsRequired: "{condition} 상세 내용이 필요합니다. --other 를 사용하여 제공하세요.",
      ...
      otherDurationRequiresRounds: "기타 지속 시간은 숫자 라운드 수가 필요합니다. 예: --duration 5 rounds.",
      invalidDuration: "지속 시간은 '제거될 때까지', 턴 종료 옵션 또는 양수 라운드 수여야 합니다.",
      ...
      moveTokenPrompt: "{name} 을(를) 지도 레이어로 이동하여 다른 토큰을 방해하지 않으면서 가시성을 유지하시겠습니까?",
      ...
      conditionReorder: "턴 순서가 변경되어 {count}개의 추적된 조건 행이 잘못된 위치에 있을 수 있습니다. 아래를 클릭하여 지정된 토큰 뒤에 복원하세요.",
      conditionsReordered: "조건 행이 지정된 토큰 뒤로 재배치되었습니다.",
      noTokensSelectedReport: "--report-token을 사용하기 전에 보드에서 하나 이상의 토큰을 선택하세요.",
      ...
      savedPromotedMasked: "Turn Tracker에 마스크된 효과가 추가되었습니다. 플레이어는 다음을 볼 수 있습니다: {publicLabel}.",
      savedPromotedGm: "효과는 GM 전용입니다. 턴 추적기 행이 생성되지 않습니다. 이 토큰이 턴 순서의 맨 위에 도달하면 알림 시스템이 이를 표시합니다.",
  ...
  handout: {
    ...
    savedEffects: {
      heading: "저장된 효과",
      intro: "저장된 효과를 사용하면 저주, 질병, 독, 숨겨진 디버프 및 기타 비전투 조건과 같은 장기 조건을 Turn Tracker 외부에 저장할 수 있습니다. 스크립트 상태로 유지되며 전투가 시작될 때 선택적으로 Turn Tracker에 복사할 수 있습니다.",
      visibility: {
        heading: "가시성 모드",
        rows: [
          [
      ...
      commands: {
        heading: "저장된 효과 명령",
        intro: "모든 --saved 명령은 GM 전용입니다. --saved 또는 --saved add를 실행하기 전에 토큰을 선택하십시오.",
        rows: [
          [
            "!조건 추적기 --저장됨",
    ...
    actorClassification: {
      heading: "배우 분류",
      intro: "Condition Tracker는 각 토큰이 PC, NPC인지 아니면 무시할 오브젝트(맵 핀, 배경, 마법 템플릿)인지를 자동으로 판단합니다. 연결되지 않은 토큰은 기본적으로 무시됩니다. --classify를 사용하여 모든 토큰의 자동 감지를 재정의하세요.",
      detectionOrder: {
        heading: "감지 순서",
        colStep: "단계",
        colCheck: "확인",
        ...
        rows: [
          ...
          [
            "3",
            "연결되지 않은 토큰 — 캐릭터 시트 없음",
            "무시됨"
          ],
          [
            "4",
            "게임 시스템 어댑터 (npc / is_npc 속성)",
            "PC / NPC"
          ],
          [
            "5",
      ...
      types: {
        ...
        rows: [
          [
            "PC",
            "플레이어 캐릭터 — 위저드와 감지에서 항상 PC로 포함"
          ],
          [
            "NPC",
            "비플레이어 캐릭터 — 항상 NPC로 포함"
          ],
          [
            "무시됨",
    ...
    availableLocales: {
      heading: "사용 가능한 번역",
      intro: "language 설정 옵션을 사용하여 채팅 메시지와 도움말 유인물을 지원되는 locale로 설정하세요. en, zh, pt에 대한 짧은 별칭도 허용됩니다.",
      colLocale: "로케일",
      colLanguage: "언어",
      colFile: "번역 파일"
    }
