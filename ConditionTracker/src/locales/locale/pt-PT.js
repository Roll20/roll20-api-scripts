  ...
  handout: {
    ...
    customEffects: {
      ...
      rows: [
        ...
        ['⬇️ Desvantagem', 'Registar uma desvantagem imposta; agrupada com a origem na iniciativa'],
    ...
    actorClassification: {
      ...
      types: {
        ...
        rows: [
          ['computador', 'Personagem jogador — sempre incluído como PJ no assistente e na deteção'],
