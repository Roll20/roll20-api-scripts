  ...
  handout: {
    ...
    commandsRef: {
      ...
      rows: [
        ...
        ['--source X --target Y --condició Z', "Aplica una condició directament sense l'assistent"],
    ...
    savedEffects: {
      ...
      visibility: {
        ...
        rows: [
          ['públic', "L'etiqueta d'efecte complet és visible al Seguidor de girs i al xat públic."],
          [
            'emmascarat',
      ...
      commands: {
        ...
        rows: [
          ...
          ['!condition-tracker --afegit guardat', "Inicieu l'assistent per afegir efectes desats."],
          [
