const TRANSLATION = {
  ...
  ui: {
    ...
    msg: {
      ...
      tokenRefNotFound: '{role} token "{value}" kunne ikke findes af id, tokennavn eller tegnnavn.',
      tokenRefAmbiguous:
  ...
  handout: {
    ...
    customEffects: {
      ...
      rows: [
        ...
        ['🎯 Evne', 'Spor en navngiven klasse- eller raceevne — du vil blive bedt om evnens navn'],
        [
          '🍀 Fordel',
    ...
    savedEffects: {
      ...
      visibility: {
        ...
        rows: [
          ...
          ['maskeret', 'En vag offentlig etiket vises til spillere; alle detaljer er kun for GM.'],
          [
            'gm',
