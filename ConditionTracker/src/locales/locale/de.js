const TRANSLATION = {
  ...
  ui: {
    ...
    msg: {
      ...
      unknownConfig: "Unbekannte Konfigurationsoption. Verwende --config, um unterstützte Einstellungen anzuzeigen.",
      macroReinstalled: "Die Makros {wizard}, {multiTarget}, {reportToken}, {saved} und {classify} wurden für alle aktuellen GM-Spieler neu installiert.",
      handoutReinstalled: "Das Hilfe-Handout {handout} wurde neu installiert.",
      duplicate: "Diese exakte Kombination aus Quelle, Subjekt, Ziel, Zustand und benutzerdefiniertem Text ist bereits aktiv.",
      noTargets: "Keine Ziel-Tokens für die Mehrfachanwendung angegeben.",
      noSelection: "Wähle mindestens einen Token auf dem Spielfeld aus, bevor du --multi-target verwendest.",
      invalidIds: "Keine gültigen Token-IDs in der aktuellen Auswahl gefunden.",
      reSelectTokens: "Keiner der ursprünglich ausgewählten Tokens konnte gefunden werden. Tokens neu auswählen und erneut versuchen.",
      conditionNotFound: "Zustands-ID nicht gefunden.",
      gmOnly: "Condition Tracker-Befehle sind nur für GMs verfügbar.",
      commandFailed: "Der Befehl konnte nicht sicher ausgeführt werden. Bitte API-Konsole prüfen.",
      ...
      subjectOnlyCustom: "--subject ist nur für Zauber, Fähigkeit, Vorteil, Nachteil und Sonstiges gültig.",
      subjectBypassInvalid: "--subjectPromptBypass erwartet true oder false, wenn ein Wert angegeben wird.",
      customDetailsRequired: "Details für {condition} sind erforderlich. Verwende --other, um sie anzugeben.",
      markerConfigFormat: "Marker-Konfigurationsformat: --config marker Grappled=grab",
      markerPredefinedRequired: "Die Marker-Konfiguration erfordert einen vordefinierten Zustandsnamen.",
      ...
      otherDurationRequiresRounds: "Die Dauer Sonstiges erfordert eine numerische Rundenzahl, zum Beispiel --duration 5 rounds.",
      invalidDuration: "Die Dauer muss Bis zur Entfernung, eine Zugende-Option oder eine positive Rundenzahl sein.",
      ...
      moveTokenPrompt: "{name} auf die Kartenebene verschieben, damit es sichtbar bleibt, aber andere Tokens nicht stört?",
      ...
      conditionReorder: "Die Rundenreihenfolge wurde geändert und {count} verfolgte Bedingungszeile(n) könnte(n) nun falsch platziert sein. Klicke unten, um sie hinter ihre zugewiesenen Tokens zu verschieben.",
      conditionsReordered: "Bedingungszeilen wurden hinter ihre zugewiesenen Tokens verschoben.",
      noTokensSelectedReport: "Wählen Sie mindestens einen Token auf der Tafel aus, bevor Sie --report-token verwenden.",
      ...
      noTokenSelectedSaved: "Wählen Sie einen Token auf der Tafel aus, bevor Sie --saved verwenden.",
      ...
      savedInvalidVisibility: "Ungültige Sichtbarkeit. Verwenden Sie „public“, „masked“ oder „gm“.",
      ...
      savedPromotedMasked: "Effekt als maskiert zum Turn Tracker hinzugefügt – Spieler sehen: {publicLabel}.",
      savedPromotedGm: "Der Effekt gilt nur für GM – es wird keine Turn-Tracker-Zeile erstellt. Das Erinnerungssystem zeigt es an, wenn dieser Spielstein die Spitze der Zugreihenfolge erreicht.",
    ...
    classify: {
      ...
      cleared: "{name} Überschreibung gelöscht (Bereich: {scope}) — automatische Erkennung wiederhergestellt.",
      setTokenFallback: "{name} → {type} (Token-Überschreibung — kein Charakterbogen verknüpft).",
      clearedTokenFallback: "{name} Token-Überschreibung gelöscht — automatische Erkennung wiederhergestellt.",
      fieldToken: "Token",
  ...
  handout: {
    ...
    footerNote: "Dieses Handout wird bei jedem Skriptstart automatisch erstellt und aktualisiert.",
    overview: {
      heading: "Übersicht",
    ...
    commandsRef: {
      ...
      rows: [
        [
          "--prompt",
          "Schritt-für-Schritt-Assistent-Oberfläche"
        ],
        [
          "--multi-target",
          "Zustand auf mehrere Ziel-Tokens anwenden"
        ],
        [
          "--Speisekarte",
        ...
        [
          "--reinstall-macro",
          "GM-Makros neu erstellen oder aktualisieren"
        ],
        [
          "--reinstall-handout",
        ...
        [
          "--help",
          "Kurze Hilfekarte im Chat anzeigen"
        ]
      ]
    },
    standardConditions: {
    ...
    durationOptions: {
      ...
      intro: "Die verbleibende Anzahl wird in der pr-Spalte des Rundentracker angezeigt und verringert sich, wenn der Ankerzug des Tokens endet.",
      colOption: "Option",
    ...
    savedEffects: {
      ...
      intro: "Mit gespeicherten Effekten können Sie langfristige Zustände außerhalb des Turn Trackers speichern – Flüche, Krankheiten, Gifte, versteckte Schwächungen und andere nicht kampfbezogene Zustände. Sie verbleiben im Skriptstatus und können optional in den Turn Tracker kopiert werden, wenn der Kampf beginnt.",
      visibility: {
      ...
      commands: {
        ...
        intro: "Alle --saved-Befehle sind nur GM. Wählen Sie ein Token aus, bevor Sie --saved oder --saved add ausführen.",
        rows: [
          [
    ...
    actorClassification: {
      ...
      intro: "Condition Tracker erkennt automatisch, ob ein Token ein SC, NSC oder ein ignoriertes Objekt (Kartenpins, Kulissen, Zaubertemplates) ist. Nicht verknüpfte Tokens werden standardmäßig ignoriert. Verwende --classify, um die automatische Erkennung für beliebige Tokens zu überschreiben.",
      detectionOrder: {
        ...
        rows: [
          ...
          [
            "3",
            "Nicht verknüpftes Token — kein Charakterbogen",
            "ignoriert"
          ],
          [
            "4",
            "Spielsystem-Adapter (npc / is_npc Attribut)",
            "PC / NPC"
          ],
          [
            "5",
          ...
          [
            "6",
            "Charakter controlledby-Fallback",
            "PC / NPC"
          ]
        ]
      },
      types: {
        ...
        rows: [
          ...
          [
            "NPC",
            "Nicht-Spieler-Charakter — immer als NSC"
          ],
          [
            "ignoriert",
    ...
    configuration: {
      ...
      intro: "Verwende !condition-tracker --config &lt;Option&gt; &lt;Wert&gt; oder die Schaltfläche Konfiguration im Hauptmenü.",
      colOption: "Option",
      colValues: "Werte",
      colDesc: "Beschreibung",
      rows: [
    ...
    availableLocales: {
      ...
      intro: "Verwende die Konfigurationsoption language, um Chat-Nachrichten und das Hilfe-Handout auf eine unterstützte Locale einzustellen. Kurze Aliase werden auch für en, zh und pt akzeptiert.",
