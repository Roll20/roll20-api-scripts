  ...
  handout: {
    ...
    durationOptions: {
      ...
      rows: [
        ...
        ['Ende des nächsten Zugs des Ziels', 'Verfällt am Ende des nächsten Zugs des Ziel-Tokens'],
        [
    ...
    actorClassification: {
      ...
      detectionOrder: {
        ...
        colResult: 'Ergebnis',
        rows: [
          ['1', 'Token-Zustandsüberschreibung (--classify --scope token)', 'PC / NPC / ignoriert'],
          [
            '2',
