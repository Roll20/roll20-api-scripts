const TRANSLATION = {
  ...
  ui: {
    ...
    msg: {
      ...
      savedConditionRequired: 'Se requiere el tipo de condición. Utilice --condition &lt;type&gt;.',
    ...
    classify: {
      ...
      setTokenFallback: '{name} → {type} (anulación de token: no hay hoja de personaje vinculada).',
    ...
    actorClassification: {
      ...
      commands: {
        ...
        rows: [
          ...
          ['!rastreador de condiciones --classify npc', 'Marca las fichas seleccionadas como NPC.'],
          [
