  ...
  handout: {
    ...
    commandsRef: {
      ...
      rows: [
        ...
        ['--config &lt;オプション&gt; &lt;値&gt;', '設定を変更する（下記の設定セクションを参照）'],
        [
    ...
    savedEffects: {
      ...
      commands: {
        ...
        rows: [
          ...
          ['!condition-tracker --saved add', '保存済みエフェクトの追加ウィザードを起動します。'],
          [
    ...
    actorClassification: {
      ...
      commands: {
        ...
        rows: [
          ...
          ['!condition-tracker --classify auto', '上書きを削除 — 自動検出を復元します。'],
          [
    ...
    configuration: {
      ...
      colDesc: '説明',
      rows: [
        ['useMarkers', 'true / false', '状態追加時にトークンへRoll20ステータスマーカーを適用する'],
        [
          'useIcons',
          '真 / 偽',
