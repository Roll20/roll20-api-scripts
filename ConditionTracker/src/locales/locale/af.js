const TRANSLATION = {
  ...
  handout: {
    ...
    durationOptions: {
      ...
      colBehaviour: 'Gedrag',
      rows: [
        ['Tot verwydering', 'Permanent — moet handmatig verwyder word via die kieslys of --remove'],
        [
    ...
    savedEffects: {
      ...
      commands: {
        ...
        rows: [
          ...
          ['!condition-tracker --gestoorde byvoeging', 'Begin die towenaar byvoeg-gestoor-effek.'],
          [
