...
+'<div style="border: 1px solid black; background-color: white; padding: 3px 3px;">'
	...
	+'<div style="padding-left:10px;margin-bottom:3px;">'
		+'<p>TokenMod provides an interface to setting almost all setable properties of a token.</p>'
	+'</div>'
	+'<b>Commands</b>'
	...
	+'<div style="padding-left:10px;">'
		...
		+'<div style="padding-left: 10px;padding-right:20px">'
			+'<b>Color</b>'
			+'<p>Colors can be any hex number color (with or without preceeding #), or the word transparent.</p>'
		...
		+'<div style="padding-left: 10px;padding-right:20px">'
			+'<b>Text</b>'
			+'<p>These can be pretty much anything.  If your value has spaces in it, you need to enclose it in '+ch("'")+' or '+ch('quot')+'.</p>'
		...
		+'<div style="padding-left: 10px;padding-right:20px">'
			...
			+'<p>Status is the only property that supports multiple values, all seperated by | as seen below. </p>'
			+'<div style="padding-left: 10px;padding-right:20px">'
				+'<pre style="white-space:normal;word-break:normal;word-wrap:normal;">'
		...
		+'<div style="padding-left: 10px;padding-right:20px">'
			...
			+'<div style="clear:both;">'+ch(' ')+'</div>'
			+'<p>Here is setting the represents to the character Bob and setting bar1 to be the npc hitpoints attribute.</p>'
			+'<div style="padding-left: 10px;padding-right:20px">'
				+'<pre style="white-space:normal;word-break:normal;word-wrap:normal;">'
