...
`GameAssist.AlmanacAssist` is created when AlmanacAssist initializes. AlmanacAssist 2.0.5 is in **Alpha Testing**; integrations should check availability and keep their manual fallback:
...
* AlmanacAssist 2.0.5 is designated **Alpha Testing** across its six included systems. The module remains optional and disabled by default; expanded campaign verification continues separately from GameAssist's release preparation.
