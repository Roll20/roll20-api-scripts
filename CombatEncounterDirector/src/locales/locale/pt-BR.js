const TRANSLATION = {
  ...
  errors: {
    ...
    unknownCommandHint:
      "Digite !director help para obter uma lista de comandos.",
    noTokensSelected:
      "Nenhum token selecionado. Selecione os tokens no mapa primeiro.",
    unknownScaleAction: 'Ação de escala desconhecida: "{action}".',
    scaleActionHint:
      "Ações válidas: predefinição, grupo, hp, ac, dano, aplicar",
    ...
    noReinforcementsToRevealHint:
      "Use !director para reforçar a duplicata primeiro.",
    ...
    encounterNameRequiredHint:
      "Exemplo: !director encontro salvar goblin-emboscada",
    encounterNotFound: 'Encontro "{name}" não encontrado.',
    encounterNotFoundHint:
      "Use !director meet list para ver os encontros salvos.",
    ...
    deckViewHint:
      "Visualizações válidas: todas, escala, posicionamento, administrador",
    ...
    invalidPartySize:
      'O tamanho do grupo deve ser um número entre 1 e 30 (obteve "{value}").',
    invalidHpPercent:
  ...
  confirm: {
    scalingPresetPending:
      "Selecione tokens e clique em Aplicar dimensionamento.",
  ...
  ui: {
    ...
    configDesc:
      "Defina quais barras de token rastreiam HP e AC e escolha o idioma da interface.",
    helpDesc:
