const TRANSLATION = {
  ...
  errors: {
    ...
    unknownCommandHint:
      "Escriba !director help para obtener una lista de comandos.",
    noTokensSelected:
      "No hay tokens seleccionados. Primero selecciona fichas en el mapa.",
    unknownScaleAction: 'Acción de escala desconocida: "{action}".',
    scaleActionHint:
      "Acciones válidas: preestablecer, fiesta, hp, ac, dañar, aplicar",
    ...
    noReinforcementsToRevealHint:
      "Utilice !director reforzar duplicado primero.",
    ...
    encounterNameRequiredHint:
      "Ejemplo: !director encuentro salvar goblin-emboscada",
    ...
    reportActionHint:
      "Acciones válidas: actualizar, seleccionar, cambiar, borrar",
    ...
    deckViewHint:
      "Vistas válidas: todas, escalado, posicionamiento, administración",
    ...
    invalidPartySize:
      'El tamaño del grupo debe ser un número entre 1 y 30 (obtuvo "{value}").',
    invalidHpPercent:
  ...
  confirm: {
    scalingPresetPending:
      "Seleccione tokens y luego haga clic en Aplicar escala.",
    journalsRebuilt:
      "Se han regenerado la plataforma de mando y el diario de estado.",
    deckUpdated:
      "La plataforma de mando se ha regenerado utilizando la vista {view}.",
    reportCleared: "Informe borrado.",
    scriptReadyHint:
