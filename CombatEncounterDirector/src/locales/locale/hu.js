const TRANSLATION = {
  ...
  errors: {
    ...
    unknownCommandHint:
      "Írja be a !director help parancsot a parancsok listájához.",
    noTokensSelected:
      "Nincs kiválasztva token. Először válassza ki a tokeneket a térképen.",
    unknownScaleAction: "Ismeretlen léptékművelet: „{action}”.",
    scaleActionHint:
      "Érvényes műveletek: előre beállított, party, hp, ac, kár, alkalmaz",
    ...
    reinforceActionHint:
      "Érvényes műveletek: másolás, felsorolás, megjelenítés",
    noReinforcementsToReveal: "Nem árulnak el újabb erősítéseket.",
    noReinforcementsToRevealHint:
      "Először használd a !director erősítő duplikációt.",
    ...
    encounterActionHint:
      "Érvényes műveletek: mentés, betöltés, törlés, listázás",
    encounterNameRequired: "Találkozási név kötelező.",
    encounterNameRequiredHint:
      "Példa: !director találkozás mentés goblin-ambush",
    ...
    reportActionHint:
      "Érvényes műveletek: frissítés, kijelölés, módosítás, törlés",
  ...
  confirm: {
    ...
    journalsRebuilt:
      "A Command Deck és az állapotnapló újragenerálásra került.",
    deckUpdated:
      "A Command Deck újra lett generálva a {view} nézet használatával.",
    reportCleared: "Jelentés törölve.",
    scriptReadyHint:
