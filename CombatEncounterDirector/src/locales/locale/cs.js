const TRANSLATION = {
  ...
  errors: {
    ...
    noTokensSelected:
      "Nejsou vybrány žádné tokeny. Nejprve vyberte žetony na mapě.",
    unknownScaleAction: 'Neznámá akce měřítka: "{action}".',
    scaleActionHint:
      "Platné akce: přednastavení, párty, hp, ac, poškození, použít",
    ...
    noReinforcementsToRevealHint:
      "Nejprve použijte !director zesílit duplikát.",
    ...
    invalidPartySize:
      "Velikost skupiny musí být číslo mezi 1 a 30 (získáno „{value}“).",
    invalidHpPercent:
      "Procento HP musí být mezi 1 a 1000 (získáno „{value}“). Příklad: 150",
    invalidAcModifier:
      'Modifikátor AC musí být mezi -10 a +10 (získáno "{value}"). Příklad: +2',
    invalidDamagePercent:
      "Procento poškození musí být mezi 1 a 1000 (získáno „{value}“). Příklad: 125",
    invalidDuplicateCount:
      "Počet duplicit musí být mezi 1 a 50 (získáno „{value}“). Příklad: 3",
  ...
  ui: {
    ...
    positionSavingDesc:
      "Snímejte pozice tokenů na aktuální stránce a kdykoli je obnovte.",
    ...
    reportingDesc:
      "Aktualizujte deník stavu souhrnem sledovaných tokenů a použitých změn.",
    configDesc:
      "Nastavte, které panely tokenů sledují HP a AC, a vyberte jazyk rozhraní.",
    helpDesc:
