const TRANSLATION = {
  ...
  errors: {
    ...
    scaleActionHint:
      "Geçerli eylemler: ön ayar, parti, hp, ac, hasar, uygulama",
    ...
    encounterNameRequiredHint:
      "Örnek: !director karşılaşması goblin pususunu kurtarır",
    ...
    reportActionHint:
      "Geçerli eylemler: yenile, seçildi, değiştirildi, temizle",
    ...
    deckViewHint:
      "Geçerli görünümler: tümü, ölçeklendirme, konumlandırma, yönetici",
    ...
    invalidHpPercent:
      'HP yüzdesi 1 ile 1000 arasında olmalıdır ("{value}" aldı). Örnek: 150',
    invalidAcModifier:
  ...
  confirm: {
    scalingPresetPending:
      "Belirteçleri seçin ve ardından Ölçeklendirmeyi Uygula'ya tıklayın.",
    journalsRebuilt: "Komuta Güvertesi ve durum günlüğü yeniden oluşturuldu.",
    deckUpdated:
      "Komuta Güvertesi {view} görünümü kullanılarak yeniden oluşturuldu.",
    reportCleared: "Rapor temizlendi.",
    scriptReadyHint:
