const TRANSLATION = {
  ...
  errors: {
    ...
    unknownCommandHint:
      "Geben Sie !director help ein, um eine Liste mit Befehlen anzuzeigen.",
    noTokensSelected:
      "Keine Token ausgewählt. Wählen Sie zuerst Token auf der Karte aus.",
    ...
    encounterActionHint:
      "Gültige Aktionen: Speichern, Laden, Löschen, Auflisten",
    encounterNameRequired: "Begegnungsname erforderlich.",
    encounterNameRequiredHint:
      "Beispiel: !director Begegnung retten Goblin-Hinterhalt",
    ...
    reportActionHint:
      "Gültige Aktionen: Aktualisieren, Ausgewählt, Geändert, Löschen",
  ...
  confirm: {
    scalingPresetPending:
      "Wählen Sie Token aus und klicken Sie dann auf Skalierung anwenden.",
