const TRANSLATION = {
  ...
  errors: {
    ...
    noTokensSelected:
      "Δεν επιλέχθηκαν διακριτικά. Επιλέξτε πρώτα διακριτικά στο χάρτη.",
    unknownScaleAction: 'Άγνωστη ενέργεια κλίμακας: "{action}".',
    scaleActionHint:
      "Έγκυρες ενέργειες: προεπιλογή, πάρτι, hp, ac, ζημιά, εφαρμογή",
    ...
    noReinforcementsToReveal:
      "Δεν υπάρχουν πρόσφατες ενισχύσεις προς αποκάλυψη.",
    noReinforcementsToRevealHint:
      "Χρησιμοποιήστε πρώτα το !director reinforce διπλότυπο.",
    ...
    encounterActionHint:
      "Έγκυρες ενέργειες: αποθήκευση, φόρτωση, διαγραφή, λίστα",
    encounterNameRequired: "Απαιτείται όνομα συνάντησης.",
    encounterNameRequiredHint:
      "Παράδειγμα: !director encounter save goblin-ambush",
    ...
    reportActionHint:
      "Έγκυρες ενέργειες: ανανέωση, επιλεγμένη, αλλαγή, διαγραφή",
  ...
  confirm: {
    scalingPresetPending:
      "Επιλέξτε διακριτικά και, στη συνέχεια, κάντε κλικ στο Apply Scaling.",
    journalsRebuilt:
      "Το Command Deck και το ημερολόγιο κατάστασης έχουν αναδημιουργηθεί.",
    deckUpdated:
      "Το Command Deck έχει αναδημιουργηθεί χρησιμοποιώντας την προβολή {view}.",
    reportCleared: "Η αναφορά διαγράφηκε.",
    scriptReadyHint:
