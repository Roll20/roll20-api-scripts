const TRANSLATION = {
  ...
  errors: {
    ...
    noTokensSelected:
      "Nessun token selezionato. Seleziona prima i token sulla mappa.",
    ...
    noReinforcementsToRevealHint:
      "Utilizzare prima !director per rinforzare il duplicato.",
    ...
    encounterNameRequiredHint:
      "Esempio: !l'incontro del regista salva l'imboscata dei goblin",
    ...
    reportActionHint:
      "Azioni valide: aggiorna, selezionato, modificato, cancella",
  ...
  confirm: {
    scalingPresetPending:
      "Seleziona i token, quindi fai clic su Applica ridimensionamento.",
    journalsRebuilt:
      "Il mazzo di comando e il diario di stato sono stati rigenerati.",
    deckUpdated:
      "Il mazzo di comando è stato rigenerato utilizzando la vista {view}.",
    reportCleared: "Rapporto cancellato.",
    scriptReadyHint:
