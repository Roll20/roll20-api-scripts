const TRANSLATION = {
  ...
  errors: {
    ...
    noReinforcementsToRevealHint:
      "Спочатку використовуйте !director reinforce duplicate.",
    ...
    encounterActionHint:
      "Допустимі дії: збереження, завантаження, видалення, список",
    encounterNameRequired: "Потрібна назва зустрічі.",
    encounterNameRequiredHint:
      "Приклад: !director encounter save goblin-ambush",
    ...
    invalidPartySize:
      'Розмір групи має бути числом від 1 до 30 (отримано "{value}").',
    invalidHpPercent:
      'Відсоток HP має бути від 1 до 1000 (отримано "{value}"). Приклад: 150',
    invalidAcModifier:
      'Модифікатор AC має бути від -10 до +10 (отримано "{value}"). Приклад: +2',
  ...
  confirm: {
    scalingPresetPending:
      "Виберіть маркери, а потім натисніть «Застосувати масштабування».",
    journalsRebuilt: "Командну колоду та журнал статусу було відновлено.",
    deckUpdated:
      "Панель команд було перетворено за допомогою перегляду {view}.",
    reportCleared: "Звіт очищено.",
    scriptReadyHint:
  ...
  ui: {
    ...
    reportingDesc:
      "Оновіть журнал статусу з описом відстежених токенів і застосованих змін.",
    configDesc:
