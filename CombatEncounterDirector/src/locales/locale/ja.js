const TRANSLATION = {
  ...
  errors: {
    ...
    unknownCommandHint:
      "コマンドのリストを表示するには、「!director help」と入力します。",
    noTokensSelected:
      "トークンが選択されていません。まずマップ上のトークンを選択します。",
    unknownScaleAction: '不明なスケール アクション: "{action}"。',
    scaleActionHint:
      "有効なアクション: プリセット、パーティー、HP、AC、ダメージ、適用",
    ...
    encounterNotFoundHint:
      "保存された遭遇を表示するには、!director 遭遇リストを使用します。",
