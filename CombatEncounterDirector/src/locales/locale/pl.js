const TRANSLATION = {
  ...
  errors: {
    ...
    encounterActionHint:
      "Prawidłowe działania: zapisz, załaduj, usuń, wylistuj",
    encounterNameRequired: "Wymagana nazwa spotkania.",
    encounterNameRequiredHint:
      "Przykład: !reżyser spotkanie zapisz zasadzkę na goblina",
    encounterNotFound: "Nie znaleziono spotkania „{name}”.",
    encounterNotFoundHint:
      "Użyj listy spotkań !director, aby zobaczyć zapisane spotkania.",
    ...
    deckViewHint:
      "Prawidłowe widoki: wszystkie, skalowanie, pozycjonowanie, admin",
    ...
    invalidPartySize:
      "Rozmiar grupy musi być liczbą z zakresu od 1 do 30 (otrzymano „{value}”).",
    invalidHpPercent:
    ...
    unexpectedErrorHint:
      "Aby uzyskać szczegółowe informacje, sprawdź konsolę API.",
  },
  confirm: {
    scalingPresetPending:
      "Wybierz tokeny, a następnie kliknij Zastosuj skalowanie.",
    journalsRebuilt: "Zregenerowano pokład dowodzenia i dziennik stanu.",
    deckUpdated:
      "Talia dowodzenia została zregenerowana przy użyciu widoku {view}.",
  ...
  ui: {
    ...
    configDesc:
      "Ustaw, które paski tokenów śledzą HP i AC, i wybierz język interfejsu.",
    helpDesc:
