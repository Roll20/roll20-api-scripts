const TRANSLATION = {
  ...
  errors: {
    ...
    unknownCommandHint:
      "Skriv !director help for at få en liste over kommandoer.",
    noTokensSelected: "Ingen tokens valgt. Vælg tokens på kortet først.",
    unknownScaleAction: 'Ukendt skalahandling: "{action}".',
    scaleActionHint:
      "Gyldige handlinger: forudindstillet, fest, hp, ac, skade, anvende",
    ...
    encounterNameRequiredHint:
      "Eksempel: !direktør støder på save goblin-baghold",
    ...
    invalidPartySize:
      'Partistørrelsen skal være et tal mellem 1 og 30 (fik "{value}").',
    invalidHpPercent:
      'HP-procenten skal være mellem 1 og 1000 (fik "{value}"). Eksempel: 150',
    invalidAcModifier:
      'AC-modifikator skal være mellem -10 og +10 (fik "{value}"). Eksempel: +2',
    invalidDamagePercent:
      'Skadeprocenten skal være mellem 1 og 1000 (fik "{value}"). Eksempel: 125',
    invalidDuplicateCount:
      'Duplikatantal skal være mellem 1 og 50 (fik "{value}"). Eksempel: 3',
  ...
  confirm: {
    ...
    deckUpdated:
      "Command Deck er blevet regenereret ved hjælp af visningen {view}.",
    reportCleared: "Rapport ryddet.",
    scriptReadyHint:
      "Åbn Combat Encounter Director - Command Deck journal for kontrolpanelet.",
  ...
  ui: {
    ...
    reinforcementsDesc:
      "Dupliker valgte tokens på kortet og autonummerer gentagne tokennavne.",
    layerVisibilityDesc:
    ...
    configDesc:
      "Indstil hvilke token-bjælker der sporer HP og AC, og vælg grænsefladesproget.",
    helpDesc:
      "Se den fulde kommandoreference eller genopbyg Command Deck og statusjournaler.",
