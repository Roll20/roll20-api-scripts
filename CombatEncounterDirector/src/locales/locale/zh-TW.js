const TRANSLATION = {
  ...
  errors: {
    ...
    invalidHpPercent:
      "HP 百分比必須介於 1 到 1000 之間（得到「{value}」）。範例：150",
    invalidAcModifier:
      "AC 修飾符必須介於 -10 和 +10 之間（得到「{value}」）。範例：+2",
    invalidDamagePercent:
      "損壞百分比必須介於 1 到 1000 之間（得到「{value}」）。範例：125",
    invalidDuplicateCount:
      "重複計數必須介於 1 到 50 之間（得到「{value}」）。範例：3",
  ...
  labels: {
    ...
    duplicateFailed: "不重複",
    duplicateFailedHint:
      "圖像不在 Roll20 庫中 — 新增到您的庫或手動設定令牌圖像。",
  },
  ui: {
