const TRANSLATION = {
  ...
  errors: {
    ...
    noTokensSelected:
      "Nenhum token selecionado. Selecione primeiro os tokens no mapa.",
    ...
    noReinforcementsToRevealHint:
      "Utilize !director para reforçar primeiro o duplicado.",
    ...
    encounterNameRequiredHint:
      "Exemplo: !director encontro salvar duende-emboscada",
    encounterNotFound: 'Encontro "{name}" não encontrado.',
    encounterNotFoundHint:
      "Utilize !director meet list para ver os encontros guardados.",
