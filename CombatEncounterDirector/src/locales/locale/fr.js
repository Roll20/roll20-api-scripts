const TRANSLATION = {
  ...
  errors: {
    ...
    noTokensSelected:
      "Aucun jeton sélectionné. Sélectionnez d’abord les jetons sur la carte.",
    unknownScaleAction: 'Action d\'échelle inconnue : "{action}".',
    scaleActionHint:
      "Actions valides : préréglage, fête, hp, ac, dégâts, appliquer",
    ...
    noReinforcementsToRevealHint:
      "Utilisez d'abord !director pour renforcer la duplication.",
    ...
    encounterActionHint:
      "Actions valides : enregistrer, charger, supprimer, lister",
    encounterNameRequired: "Nom de la rencontre requis.",
    encounterNameRequiredHint:
      "Exemple : !director rencontre save goblin-ambush",
    ...
    reportActionHint:
      "Actions valides : actualiser, sélectionné, modifié, effacer",
    ...
    deckViewHint:
      "Vues valides : toutes, mise à l'échelle, positionnement, admin",
