const TRANSLATION = {
  ...
  errors: {
    ...
    noTokensSelected:
      "선택된 토큰이 없습니다. 먼저 지도에서 토큰을 선택하세요.",
    ...
    encounterNotFoundHint:
      "저장된 만남을 보려면 !director 만남 목록을 사용하세요.",
    ...
    invalidPartySize:
      '파티 규모는 1에서 30 사이의 숫자여야 합니다("{value}" 있음).',
    invalidHpPercent:
      'HP 비율은 1에서 1000 사이여야 합니다("{value}" 있음). 예: 150',
    invalidAcModifier:
      'AC 수정자는 -10에서 +10 사이여야 합니다("{value}" 있음). 예: +2',
    invalidDamagePercent:
      '피해 비율은 1에서 1000 사이여야 합니다("{value}" 있음). 예: 125',
    invalidDuplicateCount:
      '중복 개수는 1에서 50 사이여야 합니다("{value}" 있음). 예: 3',
  ...
  confirm: {
    ...
    scriptReadyHint:
      "제어판의 Combat Encounter Director - Command Deck 저널을 엽니다.",
  ...
  ui: {
    ...
    layerVisibilityDesc:
      "선택된 토큰을 레이어 간에 이동하거나 플레이어의 가시성을 전환합니다.",
    positionSavingDesc:
      "현재 페이지의 스냅샷 토큰 위치를 확인하고 언제든지 복원하세요.",
    encounterTemplatesDesc:
      "현재 페이지 상태를 명명된 템플릿으로 저장하고 향후 세션에서 복원합니다.",
    resetRecoveryDesc:
      "추적된 토큰을 원래 상태로 복원하고 추적 기록을 제거합니다.",
    reportingDesc:
      "추적된 토큰 및 적용된 변경 사항의 요약으로 상태 저널을 새로 고칩니다.",
    configDesc:
      "HP와 AC를 추적하는 토큰 바를 설정하고 인터페이스 언어를 선택합니다.",
    helpDesc:
      "전체 명령 참조를 보거나 Command Deck 및 상태 저널을 재구성하십시오.",
    setHpBar1: "HP 바 1 설정",
    setHpBar2: "HP 바 2 설정",
    setAcBar2: "AC 바 2 설정",
    disableAc: "AC 비활성화",
