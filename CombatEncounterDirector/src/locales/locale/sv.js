const TRANSLATION = {
  ...
  errors: {
    ...
    scaleActionHint:
      "Giltiga åtgärder: förinställd, fest, hp, ac, skada, tillämpa",
    ...
    encounterNotFoundHint:
      "Använd !director möteslista för att se sparade möten.",
    ...
    invalidPartySize:
      'Partistorleken måste vara ett tal mellan 1 och 30 (fick "{value}").',
    invalidHpPercent:
      'HP-procenten måste vara mellan 1 och 1000 (fick "{value}"). Exempel: 150',
    invalidAcModifier:
  ...
  ui: {
    ...
    configDesc:
      "Ställ in vilka tokenstaplar som spårar HP och AC och välj gränssnittsspråk.",
    helpDesc:
      "Se hela kommandoreferensen eller bygg om kommandodäcket och statusjournalerna.",
