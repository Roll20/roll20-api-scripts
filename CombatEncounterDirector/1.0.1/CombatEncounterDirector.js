 ...
 * Version: 1.0.1
 * Built: 2026-06-15T02:32:49.995Z
 */
const CombatEncounterDirectorMod = (() => {
  ...
  const SCRIPT_LAST_UPDATED = '2026-06-15T02:32:49.995Z';
  ...
  const LEGACY_COMMAND = '!director';
  const DIRECTOR_CONFLICT_STATE_KEY = 'DIRECTOR_STATE';
  ...
  const LAYER_MAP = 'map';
  const VALID_LAYERS = new Set([LAYER_TOKEN, LAYER_GM, LAYER_MAP]);
  ...
  const TRANSLATION$l = {
    ...
    errors: {
      ...
      unknownCommandHint: '輸入 !ced help 以獲得命令列表。',
      ...
      noReinforcementsToRevealHint: '首先使用 !ced 加固重複項。',
      ...
      encounterNotFoundHint: '使用!ced遭遇清單查看已儲存的遭遇。',
  ...
  const TRANSLATION$j = {
    ...
    errors: {
      ...
      unknownCommandHint: 'Skriv !ced help for at få en liste over kommandoer.',
      ...
      noReinforcementsToRevealHint: 'Brug !ced forstærk duplikat først.',
      ...
      encounterNotFoundHint: 'Brug !ced-mødeliste til at se gemte møder.',
  ...
  const TRANSLATION$2 = {
    ...
    errors: {
      ...
      unknownCommandHint: 'Skriv !ced help för en lista med kommandon.',
      ...
      noReinforcementsToRevealHint: 'Använd !ced förstärka duplicate först.',
      ...
      encounterNotFoundHint: 'Använd !ced möteslista för att se sparade möten.',
   ...
   * @returns {void}
   */
  function handleLegacyInput(msg) {
    if (msg.type !== 'api') {
      return;
    }
