...
// global.createCharacter = (id: string, name: string, controlledby: string = ""): MockCharacter => {
//   const char = new MockCharacter(id, name, controlledby);
//   global.characters.push(char);
//   return char;
// };

// // Helper function to create tokens
// global.createToken = (id: string, representsId: string): Token => {
//   const token: Token = {
//     id,
//     represents: representsId,
//     get: (prop: string): string => prop === "represents" ? representsId : ""
//   };
//   global.selectedTokens.push(token);
//   return token;
// };

// // Helper function to create attributes
// global.createAttribute = (charId: string, name: string, current: string = "", max: string = ""): MockAttribute => {
//   const attr = new MockAttribute({
//     _characterid: charId,
//     name,
//     current,
//     max
//   });
//   global.attributes.push(attr);
//   return attr;
// };
