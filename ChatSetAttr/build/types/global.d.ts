...
interface Roll20Object<T extends Record<string, any>> {
  ...
  /**
   * Remove this object from Roll20
   */
  remove(): void;
}

// Campaign type with proper properties
...
// Player type with proper properties
...
// Page type with proper properties
type PageProperties = {
  _id: string;
  _type: "page";
  _zorder: string;
...
// Path type with proper properties
type PathProperties = {
  _id: string;
  _type: "path";
  _pageid: string;
...
/**
 * Gets the value of a sheet item for a character (2024 sheet)
 * @param character_id The ID of the character
 ...
 *
 * @remarks
 * This is an asynchronous function that returns a Promise. It is used with the 2024 sheet.
 *
...
/**
 * Sets the value of a sheet item for a character (2024 sheet)
 * @param character_id The ID of the character
 * @param item_name The name of the sheet item
 ...
 */
declare function setDefaultTokenForCharacter(character: Roll20Object, token: Roll20Object): void;
...
declare function on(
  event: `change:${Roll20ObjectType}`,
  callback: (obj: Roll20Object, prev: Record<string, any>) => void
): void;
declare function on(
  event: `add:${Roll20ObjectType}` | `destroy:${Roll20ObjectType}`,
  callback: (obj: Roll20Object) => void
): void;
declare function on(
  event: `change:${Roll20ObjectType}:${string}`,
  callback: (obj: Roll20Object, prev: Record<string, any>) => void
): void;
...
// type UniqueIdentifier = string | number | symbol;
