...
var chatSetAttr = chatSetAttr || (function() {
	...
	getAllAttributes = function(who, list, setting, createMissing) {
		...
		let standardAttrs = getStandardAttributes(who, list, settingStandard, createMissing);
		let repeatingAttrs = getRepeatingAttributes(who, list, settingRepeating, createMissing);
		let allAttrs = {};
