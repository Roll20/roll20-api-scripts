...
const OVERRIDE_FLAGS = [FLAG_DURATION, FLAG_MODE, FLAG_BEAM_FX, FLAG_BURST_FX];
...
function announce(msg, header = "") {
  sendChat("SwapTokenPositions", generateStyledMessage(msg, "center", header));
}
...
/**
 * Registers the API command handler and initializes persistent state when the script is ready.
 *
 * @returns {void}
 */
on("ready", () => {
