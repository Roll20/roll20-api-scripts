...
var initMaster = (function() {		// eslint-disable-line no-unused-vars
	...
	InitMaster_Help:	{name:'InitiativeMaster Help',
						 ...
						 bio:'<div style="font-weight: bold; text-align: center; border-bottom: 2px solid black;">'
							+'<span style="font-weight: bold; font-size: 125%">InitiativeMaster Help v2.08</span>'
							+'</div>'
							...
							+'<ul>'
							+'<li><mark style="color:green">New</mark> Maths extended to use sheet fields</li>'
							+'</ul>'
							...
							+'--set-mods [token-id]|cmd|name|[=][+/-]mod|[=][+/-]mult|[SILENT]</pre>'
