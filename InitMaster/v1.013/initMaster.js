...
//----------------------------------- button press handlers ------------------------------------------	
	...
	**/
	...
	var handleInitMonster = function( monster, charCS, sheetTypes, args ) {
		...
		speedMult = (attrLookup( charCS, fields.initMultiplier[0], fields.initMultiplier[1]) || 1);
	...
	**/
	...
	var handleInitSubmit = function( senderId, charCS, sheetTypes, args ) {
		...
		var	charName = charCS.get('name'),
			...
			init_Mult = (attrLookup( charCS, fields.initMultiplier[0], fields.initMultiplier[1] ) || 1),
