		...
		var content = 
			'<div style="background-color: #FFF; border: 2px solid #000; box-shadow: rgba(0,0,0,0.4) 3px 3px; border-radius: 0.5em; margin-left: 2px; margin-right: 2px; padding-top: 5px; padding-bottom: 5px;">'
				...
				+ '<div style="padding-left: 5px; padding-right: 5px; overflow: hidden;">'
					...
					+ '</div>'
					+ '<li style="padding-left: 10px;">'
						+ 'Display a menu of possible attack actions.'
					+ '</li>'
					+ '<li style="padding-left: 20px;">'
						+ '<b>tokenID</b> of the token doing the attack actions.'
					+ '</li>'
					+ '<br>'
					+ '<div style="font-weight: bold;">'
						+ '!attk --attk-hit tokenID|monsterAttk1|monsterAttk2|monsterAttk3\n'
						+ '!attk --attk-roll tokenID|monsterAttk1|monsterAttk2|monsterAttk3\n'
						+ '!attk --attk-target tokenID|monsterAttk1|monsterAttk2|monsterAttk3\n'
					+ '</div>'
					+ '<li style="padding-left: 10px;">'
						+ '3 different forms of display for possible attacks with the weapons in hand. '
						+ '-hit Roll20 rolls 3D dice, -roll player rolls dice, -target (GM only) all attk stats provided'
					+ '</li>'
					+ '<li style="padding-left: 20px;">'
						+ '<b>tokenID</b> of the token doing the attack actions.'
					+ '</li>'
					...
					+ '</div>'
					+ '<li style="padding-left: 10px;">'
						+ 'Select weapons from the equipment bag (same as the MagicMaster MIBag) to hold in Left and Right (1H weapons), '
						+ 'or Both hands (2H weapons).  Such weapons must be specified in MI database in line with RedMaster Docs.'
					+ '</li>'
					+ '<li style="padding-left: 20px;">'
						+ '<b>tokenID</b> of the token to set weapons for.'
					+ '</li>'
					+ '<br>'
					+ '<div style="font-weight: bold;">'
						+ '!attk --ammo tokenID'
					+ '</div>'
					+ '<li style="padding-left: 10px;">'
						+ 'Display a menu to recover ammo.  Displays all character\'s ammo, whether in hand or not'
					+ '</li>'
					+ '<li style="padding-left: 20px;">'
						+ '<b>tokenID</b> of the token to display the ammo for.'
					+ '</li>'
					+ '<br>'
					+ '<div style="font-weight: bold;">'
						+ '!attk --showac tokenID'
					+ '</div>'
					+ '<li style="padding-left: 10px;">'
						+ 'Display a menu to view and change armour class values.'
					+ '</li>'
					+ '<li style="padding-left: 20px;">'
						+ '<b>tokenID</b> of the token to display AC for.'
					+ '</li>'
					+ '<br>'
				+ '</div>'
   			+ '</div>'; 
