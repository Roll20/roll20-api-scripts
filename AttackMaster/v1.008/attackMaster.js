...
// --------------------------------------------------------------- Button press Handlers ----------------------------------------------
	...
	var handleAmmoChange = function( args ) {
		...
		var tokenID = args[1],
			...
			charCS = getCharacter(tokenID),
			isMI = args[0].includes(BT.AMMO),
			Ammo, ammoIndex, ammoMIname = ammoName,
			MagicItems, miIndex;
		...
		if (!isMI) {
			...
			Ammo = getTable(charCS,Ammo,'Ammo_qty',fields.Ammo_table,fields.Ammo_qty,'',0);
			Ammo = getTable(charCS,Ammo,'Ammo_maxQty',fields.Ammo_table,fields.Ammo_maxQty,'',0);
