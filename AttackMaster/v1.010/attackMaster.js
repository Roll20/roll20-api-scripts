...
// -------------------------------------------------------------- Register the API -------------------------------------------
	...
	var cmdMasterRegister = function() {
		var cmd = fields.commandMaster
				+ ' --register Attack-hit|Do an attack where Roll20 rolls the dice|attk|~~attk-hit|`{selected|token_id}'
				+ ' --register Attack-roll|Do an attack where player rolls the dice|attk|~~attk-roll|`{selected|token_id}'
				+ ' --register Attack-target|Do an attack with full target statistics (GM-only)|attk|~~attk-target|`{selected|token_id}'
				+ ' --register Attack-menu|Display a menu of attack functions|attk|~~menu|`{selected|token_id}';
		sendAttkAPI( cmd );
		return;
	};
