	...
	*/
	...
	var sendResponse = function(charCS,msg,as,img) {
		...
		content = to
				...
				+ '</div>'
				+ msg;
		sendChat((as ? as:fields.feedbackName),content,null,(flags.archive ? null:{noarchive:true}));
	}; 
...
// ------------------------------------------------------------- Command Action Functions ---------------------------------------------
	...
	*/
	...
	var doDisplayACmenu = function( args ) {
	...
	var doSetAC = function( args, displayMenu ) {
