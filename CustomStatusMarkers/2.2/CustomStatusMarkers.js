...
var CustomStatusMarkers = (() => {
  'use strict';
    ...
    const SAVE_MARKER_CMD = '!saveMarker';
    const SET_MARKER_CMD = '!setMarker';
    const DEL_MARKER_CMD = '!delMarker';
    const CONFIRM_DEL_MARKER_CMD = '!_delMarkerConfirm';
    const CLEAR_STATE_CMD = '!clearCustomStatusMarkersState';
    const CLEAR_TOKEN_CMD = '!clearMarkersTokenState';
    const MENU_CMD = '!CustomStatusMarkers';
