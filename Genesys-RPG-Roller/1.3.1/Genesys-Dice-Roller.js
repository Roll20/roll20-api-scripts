...
const IMAGE_LOCATION = "https://raw.githubusercontent.com/Roll20/roll20-api-scripts/master/Genesys-RPG-Roller/Dice/";
...
eote.defaults = {
    ...
    graphics: {
        ...
        ABILITY: {
            BLANK: `${IMAGE_LOCATION}/Ability/ability-6.png`,
            A: `${IMAGE_LOCATION}/Ability/ability-3.png`,
            AA: `${IMAGE_LOCATION}/Ability/ability-5.png`,
            S: `${IMAGE_LOCATION}/Ability/ability-1.png`,
            SA: `${IMAGE_LOCATION}/Ability/ability-4.png`,
            SS: `${IMAGE_LOCATION}/Ability/ability-2.png`
        },
        BOOST: {
            BLANK: `${IMAGE_LOCATION}/Boost/boost-5.png`,
            A: `${IMAGE_LOCATION}/Boost/boost-2.png`,
            AA: `${IMAGE_LOCATION}/Boost/boost-3.png`,
            S: `${IMAGE_LOCATION}/Boost/boost-1.png`,
            SA: `${IMAGE_LOCATION}/Boost/boost-4.png`
        },
        CHALLENGE: {
            BLANK: `${IMAGE_LOCATION}/Challenge/challenge-7.png`,
            F: `${IMAGE_LOCATION}/Challenge/challenge-1.png`,
            FF: `${IMAGE_LOCATION}/Challenge/challenge-2.png`,
            FT: `${IMAGE_LOCATION}/Challenge/challenge-4.png`,
            T: `${IMAGE_LOCATION}/Challenge/challenge-3.png`,
            TT: `${IMAGE_LOCATION}/Challenge/challenge-5.png`,
            DESPAIR: `${IMAGE_LOCATION}/Challenge/challenge-6.png`
        },
        DIFFICULTY: {
            BLANK: `${IMAGE_LOCATION}/Difficulty/difficulty-6.png`,
            F: `${IMAGE_LOCATION}/Difficulty/difficulty-1.png`,
            FF: `${IMAGE_LOCATION}/Difficulty/difficulty-2.png`,
            FT: `${IMAGE_LOCATION}/Difficulty/difficulty-5.png`,
            T: `${IMAGE_LOCATION}/Difficulty/difficulty-3.png`,
            TT: `${IMAGE_LOCATION}/Difficulty/difficulty-4.png`
        },
        PROFICIENCY: {
            BLANK: `${IMAGE_LOCATION}/Proficiency/proficiency-7.png`,
            A: `${IMAGE_LOCATION}/Proficiency/proficiency-3.png`,
            S: `${IMAGE_LOCATION}/Proficiency/proficiency-1.png`,
            SA: `${IMAGE_LOCATION}/Proficiency/proficiency-4.png`,
            SS: `${IMAGE_LOCATION}/Proficiency/proficiency-2.png`,
            AA: `${IMAGE_LOCATION}/Proficiency/proficiency-5.png`,
            TRIUMPH: `${IMAGE_LOCATION}/Proficiency/proficiency-6.png`
        },
        SETBACK: {
            BLANK: `${IMAGE_LOCATION}/Setback/setback-3.png`,
            F: `${IMAGE_LOCATION}/Setback/setback-1.png`,
            T: `${IMAGE_LOCATION}/Setback/setback-2.png`
        },
        SYMBOLS: {
            A: `${IMAGE_LOCATION}/Symbols/advantage.png`,
            S: `${IMAGE_LOCATION}/Symbols/success.png`,
            T: `${IMAGE_LOCATION}/Symbols/threat.png`,
            F: `${IMAGE_LOCATION}/Symbols/failure.png`,
            TRIUMPH: `${IMAGE_LOCATION}/Symbols/triumph.png`,
            DESPAIR: `${IMAGE_LOCATION}/Symbols/despair.png`
        },
        SymbolicReplacement: {}
    },
    regex: {
