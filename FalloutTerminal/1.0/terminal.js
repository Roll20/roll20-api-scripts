(function() {
  ...
  function _displayScreen(id) {
    ...
    var html = '<table style="background-color: #000; border: solid 1px #000; border-collapse: separate; border-radius: 10px; font-family: monospace; overflow: hidden; width: 100%;">';
    ...
    html += '</thead>';
    html += '<tbody>';
    html += '<tr><td style ="color: #22ff88; padding: 0.5em;">';
    if(screen)
  ...
  function _displayScreenButton(cmd, label) {
    return '<a href="' + cmd + '" style="background: #114422; border: none; color: #22ff88; margin: 0.2em 0; width: 95%;">' + label + '</a>';
  }
