...
const SelectManager = (() => { //eslint-disable-line no-unused-vars
    ...
    const typeitemrx = /^(?<type>bar|max|aura|color|layer|tip|gmnotes|type|pc|npc|pt|side)(?<ident>1|2|3|4)?(?<=(?:bar|max)\d|(?:aura|color)[1,2]|(?:layer|tip|gmnotes|type|pc|npc|pt|side))$/i;
