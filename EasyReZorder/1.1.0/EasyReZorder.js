...
var EasyReZorder = EasyReZorder || (() => {
    ...
    const handleInput = (msg) => {
        ...
        // ScriptKit handles help, man, whatsnew, gen-help, gen-dev-docs
        ...
        if (!args.length) { if (typeof ScriptKit !== 'undefined') ScriptKit.usage(msg); return; }
        ...
        switch (cmd) {
            ...
            default:
                ...
                else reply(msg, 'Error', `Unknown action: ${cmd}. Use ${CMD_TOKEN} help.`);
        }
    };
    ...
    const registerWithScriptKit = () => {
        ...
        ScriptKit.register(SCRIPT_NAME, {
            ...
            newSince: '1.1.0',
            motd: [
                '`!z-order forward 3` moves selected tokens forward by 3 positions in the stacking order.',
                'Use `!z-order check` to see the exact z-index of selected tokens.',
                '`!z-order ahead-of <id>` places tokens just above a specific object — great for layering.',
            ...
            help: {
                ...
                changelog: [
                    ...
                    { version: '1.0.0', date: '2026-06-12', changes: [
                        'Initial release',
                        'Forward/backward by N steps',
                        'Bring to front / send to back',
                        'Ahead-of / behind relative positioning',
                        'Z-order check (show index)',
                        'Anchor.updateZOrder integration',
                    ]},
                ],
                commands: [
                    { syntax: 'forward [n]', description: 'Move forward n steps (default: 1)', version: '1.0.0' },
                    { syntax: 'backward [n]', description: 'Move backward n steps (default: 1)', version: '1.0.0' },
                    { syntax: 'front', description: 'Bring to front', version: '1.0.0' },
                    { syntax: 'back', description: 'Send to back', version: '1.0.0' },
                    { syntax: 'ahead-of <id>', description: 'Move ahead of a specific object', version: '1.0.0' },
                    { syntax: 'behind <id>', description: 'Move behind a specific object', version: '1.0.0' },
                    { syntax: 'check', description: 'Show z-order index of selected objects', version: '1.0.0' },
                ],
            },
        });
    };
