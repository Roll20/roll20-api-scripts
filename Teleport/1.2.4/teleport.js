    ...
    const Teleport = (() => {
        ...
        */
        ...
        helpDisplay = function(){
            ...
            output += "<p>To set up cross-page teleport, you must create teleport tokens on each page you want to link by way of teleport, and then use the Global Teleport Pad List to link them, similar to how you did in the <b>Beginning Setup</b>. The latest version, 1.2.4, of <b>Teleport</b> now will first look for an existing token on a target page, will try and create one if there is not one, and if you have Experimental set on your sandbox will even do this with tokens from the Marketplace.</p>";
