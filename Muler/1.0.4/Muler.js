...
const Muler = (() => {
    ...
    const mulegetter = (msg, msgstate) => {
        ...
        msg.content = msg.content.replace(getrx, (m, gvar) => {
            let gchar, gmule;
            ...
            if (retval) {
                ...
                notes.push(`Unable to resolve variable: get.${fullgvar}`);
            }
            return retval || `get.${fullgvar}`; // leaving the `get.` trusting ZeroFrame to stop infinite loops of processing
        });
