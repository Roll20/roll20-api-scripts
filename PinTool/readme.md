...
For full documentation, thype `!pintool --help` into chat once installed. This will create an in-game documentation handout.
...
- `--transform` — Apply transformations to pins, e.g., auto-generating icon text from titles, or transferring an image
