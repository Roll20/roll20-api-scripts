...
var RoundMaster = (function() {
	...
	Effects_DB:		{version:5.0,
					avatar:'https://s3.amazonaws.com/files.d20.io/images/2795868/caxnSIYW0gsdv4kOmO294w/thumb.png?1390102911',
					bio:'',
					gmnotes:'',
					db:[{name:'3min-geyser-end',type:'',ct:0,charge:'uncharged',cost:0,body:'!tj --addtotracker 3min-Geyser|-1|[[1d10]]|0|3min Geyser blows'},
						{name:'5min-geyser-end',type:'',ct:0,charge:'uncharged',cost:0,body:'!tj --addtotracker 5min-Geyser|-1|[[1d10]]|0|5min Geyser blows'},
						{name:'Aid-end',type:'',ct:0,charge:'uncharged',cost:0,body:'^^cname^^\'s *Aid* has come to an end, and Thac0 \\amp HP return to normal\n!token-mod --ignore-selected --ids ^^tid^^ --set bar2_current|+1 --set bar3_current|[[{ {^^bar3_current^^},{@{Effects|aid^^tid^^} } }kl1]]'},
						{name:'Aid-start',type:'',ct:0,charge:'uncharged',cost:0,body:'^^cname^^ gains *Aid* from a Priest\'s god, improving Thac0 and HP\n!setattr --silent --name Effects --aid^^tid^^|^^bar3_current^^\n!token-mod --ignore-selected --ids ^^tid^^ --set bar2_current|-1 --set bar3_current|+[[1d8]]'},
						{name:'Barkskin-end',type:'',ct:0,charge:'uncharged',cost:0,body:'!token-mod --ignore-selected --ids ^^tid^^ --set bar1_current|@{Effects|Barkskin^^tid^^}\n^^cname^^\'s AC returns to normal as Barkskin fades'},
						{name:'Barkskin-start',type:'',ct:0,charge:'uncharged',cost:0,body:'!setattr --silent --name Effects --Barkskin^^tid^^|^^bar1_current^^\n!token-mod --ignore-selected --ids ^^tid^^ --set bar1_current|[[{ {^^bar1_current^^}, {[[6-floor(@{PR-Spells|casting-level}/4)]]} }kl1]]\n^^cname^^\'s AC might have improved as they get Barkskin'},
						...
						{name:'Enfeeble-monster-end',type:'',ct:0,charge:'uncharged',cost:0,body:'!token-mod --ignore-selected --ids ^^tid^^ --set bar2_current|-2 bar2_max|+2\nThe monster has recovered from being enfeebled'},
						{name:'Enfeeble-monster-start',type:'',ct:0,charge:'uncharged',cost:0,body:'!token-mod --ignore-selected --ids ^^tid^^ --set bar2_current|+2 bar2_max|-2\nThe monster has been enfeebled'},
						{name:'Exhausted-end',type:'',ct:0,charge:'uncharged',cost:0,body:'!modattr --fb-public --name ^^cname^^ --fb-from Effects --fb-header ^^cname^^ has recovered from Exhaustion --thac0|-2 --ac|-2 --strengthdmg||+2'},
						{name:'Faerie-fire-darkness-end',type:'',ct:0,charge:'uncharged',cost:0,body:'!token-mod --ignore-selected --ids ^^tid^^ --set bar1_current|-2\n^^tname^^ has lost that glow and is now harder to aim at'},
						{name:'Faerie-fire-darkness-start',type:'',ct:0,charge:'uncharged',cost:0,body:'!token-mod --ignore-selected --ids ^^tid^^ --set bar1_current|+2\n^^tname^^ is surrounded by Faerie Fire, and becomes much easier to hit'},
						{name:'Faerie-fire-twilight-end',type:'',ct:0,charge:'uncharged',cost:0,body:'!token-mod --ignore-selected --ids ^^tid^^ --set bar1_current|-1\n^^tname^^ has lost that glow and is now harder to aim at'},
						{name:'Faerie-fire-twilight-start',type:'',ct:0,charge:'uncharged',cost:0,body:'!token-mod --ignore-selected --ids ^^tid^^ --set bar1_current|+1\n^^tname^^ is surrounded by Faerie Fire, and becomes easier to hit'},
						...
						{name:'Glitterdust-end',type:'',ct:0,charge:'uncharged',cost:0,body:'!token-mod --ignore-selected --ids ^^tid^^ --set bar1_current|-4 --set bar2_current|-4\n!modattr --silent --name ^^cname^^ --comreact|-2\n^^tname^^ has recovered from Glitterdust blindness and no longer suffers from penalties to attacks, AC and initiative'},
						{name:'Glitterdust-start',type:'',ct:0,charge:'uncharged',cost:0,body:'!token-mod --ignore-selected --ids ^^tid^^ --set bar1_current|+4 bar2_current|+4\n!modattr --silent --name ^^cname^^ --comreact|+2\n^^tname^^ has been blinded by glitterdust and suffers 4 penalty to attacks \\amp AC, and 2 penalty to initiative'},
						{name:'Hairy-Spider-Poison-end',type:'',ct:0,charge:'uncharged',cost:0,body:'!token-mod --ignore-selected --ids ^^tid^^ --set bar1_value|-1 bar2_value|-1\n!modattr --silent --charid ^^cid^^ --dexterity|+3'},
						{name:'Hairy-Spider-Poison-start',type:'',ct:0,charge:'uncharged',cost:0,body:'!token-mod --ignore-selected --ids ^^tid^^ --set bar1_value|+1 bar2_value|+1\n!modattr --silent --charid ^^cid^^ --dexterity|-3'},
						...
						{name:'Heroes-Feast-end',type:'',ct:0,charge:'uncharged',cost:0,body:'!token-mod --ignore-selected --ids ^^tid^^ --set bar2_current|+1\nThe effects of Heroes Feast have worn off, and ^^tname^^ returns to normal'},
						{name:'Heroes-Feast-start',type:'',ct:0,charge:'uncharged',cost:0,body:'!token-mod --ignore-selected --ids ^^tid^^ --set bar2_current|-1\nHaving eaten a Heroes Feast, ^^tname^^ gains benefits to attacks as well as other bonuses'},
						...
						{name:'Invisibility-end',type:'',ct:0,charge:'uncharged',cost:0,body:'!token-mod --ignore-selected --ids ^^tid^^ --set bar1_current|+4\nBecoming visible means ^^cname^^\'s AC returns to normal'},
						{name:'Invisibility-start',type:'',ct:0,charge:'uncharged',cost:0,body:'!token-mod --ignore-selected --ids ^^tid^^ --set bar1_current|-4\nBeing invisible improves ^^cname^^\'s AC by 4'},
						{name:'Invulnerability-end',type:'',ct:0,charge:'uncharged',cost:0,body:'!token-mod --ignore-selected --ids ^^tid^^ --set bar1_current|+2\n^^tname^^ is no longer invulnerable-ish'},
						{name:'Invulnerability-start',type:'',ct:0,charge:'uncharged',cost:0,body:'!token-mod --ignore-selected --ids ^^tid^^ --set bar1_current|-2\n^^tname^^ becomes invulnerable to normal attacks from many creatures (but not all, and not magical attacks)'},
						...
						{name:'Light-end',type:'',ct:0,charge:'uncharged',cost:0,body:'!token-mod --ignore-selected --ids ^^tid^^ --set bar1_current|-4 --set bar2_current|-4\n^^tname^^ has recovered from blindness and no longer suffers from penalties to attacks and AC'},
						{name:'Light-start',type:'',ct:0,charge:'uncharged',cost:0,body:'!token-mod --ignore-selected --ids ^^tid^^ --set bar1_current|+4 --set bar2_current|+4\n^^tname^^ has been blinded by light and suffers 4 penalty to attacks \\amp AC'},
						...
						{name:'Prayer-ally-end',type:'',ct:0,charge:'uncharged',cost:0,body:'!token-mod --ignore-selected --ids ^^tid^^ --set bar2_current|+1\n!modattr --silent --name ^^cname^^ --strengthdmg||-1\n^^cname^^ loses the benefit of *Prayer*'},
						{name:'Prayer-ally-start',type:'',ct:0,charge:'uncharged',cost:0,body:'!token-mod --ignore-selected --ids ^^tid^^ --set bar2_current|-1\n!modattr --silent --name ^^cname^^ --strengthdmg||+1\n^^cname^^ gains the benefit of *Prayer*, with improved attacks and damage'},
						{name:'Prayer-foe-end',type:'',ct:0,charge:'uncharged',cost:0,body:'!token-mod --ignore-selected --ids ^^tid^^ --set bar2_current|-1\n!modattr --silent --name ^^cname^^ --strengthdmg||+1\n^^cname^^ loses the impact of *Prayer*'},
						{name:'Prayer-foe-start',type:'',ct:0,charge:'uncharged',cost:0,body:'!token-mod --ignore-selected --ids ^^tid^^ --set bar2_current|+1\n!modattr --silent --name ^^cname^^ --strengthdmg||-1\n^^cname^^ bears the penalties of *Prayer*, with worse attacks and damage'},
						...
						{name:'Rage-end',type:'',ct:0,charge:'uncharged',cost:0,body:'!modattr --fb-public --name ^^cname^^ --fb-from Effects --fb-header ^^cname^^ is now Exhausted --thac0|+4 --ac|+4 --strengthdmg||[[-4]] --hp|-15\n!tj --addtargetstatus ^^tid^^|Exhausted|10|-1|Exhausted - 2 worse on attk,dmg,ac|radioactive'},
						{name:'Rage-start',type:'',ct:0,charge:'uncharged',cost:0,body:'!modattr --fb-public --name ^^cname^^ --fb-from Effects --fb-header ^^cname^^ is Raging! --thac0|-2 --ac|-2 --strengthdmg||2 --hp|+15'},
						...
						{name:'Regeneration-turn',type:'',ct:0,charge:'uncharged',cost:0,body:'!token-mod --ignore-selected --ids ^^tid^^ --set bar3_current|+[[@{^^cname^^|conregen}]]! --report control|"{name} regenerates {bar3_current:change} HP"'},
						...
						{name:'Something-wrong-end',type:'',ct:0,charge:'uncharged',cost:0,body:'!tj --addtargetstatus ^^tid^^|GS-Acid-dmg|99|0|Take acid damage to feet|tread'},
						...
						{name:'Tashas-UHL-monster-end',type:'',ct:0,charge:'uncharged',cost:0,body:'!token-mod --ignore-selected --ids ^^tid^^ --set bar2_current|-2 bar2_max|+2\nThe monster regains strength as they stop laughing'},
						{name:'Tashas-UHL-monster-start',type:'',ct:0,charge:'uncharged',cost:0,body:'!token-mod --ignore-selected --ids ^^tid^^ --set bar2_current|+2 bar2_max|-2\nThe monstr loses strength as they laugh so hard!'},
...
//		setTimeout( () => doUpdateEffectsDB(['Silent']), 10000);
		doUpdateEffectsDB(['Silent']);
...
*/              // RED: v2.007 introduced the new initMaster API script.  Send it the round counter
	...
	**/
	...
	var buildCSdb = function( dbName, dbObj, silent ) {
		
//		log('Called buildCSdb with dbName='+dbName);

		dbName = dbName.replace(/_/g,'-');
		
		var dbCS = findObjs({ type:'character', name:dbName }),
			dbVersion = 0.0,
			errFlag = false,
			lists = {},
			spells = dbName.toLowerCase().includes('spells') || dbName.toLowerCase().includes('powers'),
			msg, versionObj;
		
		if (!dbCS || !dbCS.length) {
			dbCS = createObj( 'character', {name:dbName} );
		} else {
			dbCS = dbCS[0];
		}
		
		versionObj = findAttrObj( dbCS, 'dbVersion' );
		dbVersion = versionObj.get('current');
		
//		log('buildCSdb: got dbCS with name='+dbCS.get('name'));
		if (dbVersion >= dbObj.version) {
			msg = dbName+' v'+dbVersion+' not updated as is already latest version';
			if (!silent) {
				sendFeedback(msg); 
			} else {
				log(msg);
...
//				log('buildCSdb: unable to set database '+dbName+' entry '+item.name);
	 ...
	 */
	var doSetAOE = function( args, senderID ) {
		...
		if (question) {
			...
			content = '&{template:default}{{name=Confirm AOE placement}}'
					+ '{{AOE='+(range > 0?' Move the crosshair within the range depicted by the green area, then':(range==0?'. Range is 0.':' within the range, then'))
					+ '[Confirm](!rounds --aoe '+args.join('|')+') Area of Effect placement}}'
...
//		log('doUpdateDB: args[0] = '+args[0]+', args[1] = '+args[1]+', silent = '+silent);
		...
		if (dbName && dbName.length) {
			...
			if (!silent) sendFeedback('Updating all databases');
			_.each( dbNames, (db,k) => buildCSdb( k, db, silent ));
		}
