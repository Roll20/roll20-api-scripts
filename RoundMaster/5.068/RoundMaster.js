 ...
 * v5.066  11/05/2026 Fixed issue with many areas of effect using maths for range or dimensions.
 *                    Trapped ghost token ids, informing GM of error.  Preserved caster id when casting
 ...
 * v5.067  10/06/2026 Fixed declaration of sendCatchError().
 * v5.068  11/06/2026 Remove references to legacy Initiative character sheet macro DB. Added calls to
 *                    new !init --turn command to inform initMaster of token turns. Added Ankheg power
 *                    effects.
 **/
	...
	v7Effects:	{
		Effects_DB:	{bio:'<blockquote>Token Marker Effects Macro Library</blockquote><br><br>v7.13 02/08/2026<br><br>This database holds the definitions for all token status effects.  These are macros that optionally are triggered when a status of the same root name is placed on a token (statusname-start), each round it is still on the token (statusname-turn), and when the status countdown reaches zero or the token dies or is deleted (statusname-end)  There are also other possible status conditions such as weaponname-inhand, weaponname-dancing and weaponname-sheathed.  See the <b>RoundMaster API</b> documentation for further information.<br><br><b>Important Note:</b> Effects require a Roll20 Pro membership, and the installation of the ChatSetAttr, Tokenmod and RoundMaster API Scripts, to allow parameter passing between macros, update of character sheet variables, and marking spell effects on tokens.  If you do not have this level of subscription, I highly recommend you get it as a DM, as you get lots of other goodies as well.  If you want to know how to load the API Scripts to your game, the RoLL20 API help here gives guidance, or Richard can help you.<br><br><b>Important Note for DMs:</b> if a monster character sheet has multiple tokens associated with it, and token markers with associated Effects are placed on more than one of those Tokens, any Effect macros will run multiple times and, if changing variables on the Character Sheet using e.g. ChatSetAttr will make the changes multiple times to the same Character Sheet - generally this will cause unexpected results!  If using these Effect macros for Effects that could affect monsters in this way, it is <b>HIGHLY RECOMMENDED</b> that a 1 monster Token : 1 character sheet approach is adopted.',
					...
					db:[{name:'3min-geyser-end',type:'',ct:'0',charge:'uncharged',cost:'0',body:'!rounds --addtotracker 3min-Geyser|-1|[[1d10]]|0|3min Geyser blows'},
						...
						{name:'Advantage-Surprise-end',type:'',ct:'0',charge:'uncharged',cost:'0',body:'!attk --set-mods ^^tcid^^|del|Surprise|Manual Advantage\n!magic --message ^^tid^^|Advantage on Surprise|^^tname^^ is no longer gaining Advantage set by the GM on rolls for surprise. Other sources of Advantage will still apply.'},
						{name:'Advantage-Surprise-start',type:'',ct:'0',charge:'uncharged',cost:'0',body:'!rounds --removetargetstatus ^^tid^^|disadvantage-surprise|silent\n!attk --set-mods ^^tid^^|add|Surprise|Manual Advantage|adsur:+1\n!magic --message ^^tid^^|Advantage on Surprise|^^tname^^ is gaining Advantage on rolls for surprise'},
						...
						{name:'Ankheg-Acid-end',type:'',ct:'0',charge:'uncharged',cost:'0',body:'!magic --power-per-day ^^tid^^|Ankheg-Acid-Jet|=1'},
						{name:'Ankheg-Digestion-turn',type:'',ct:'0',charge:'uncharged',cost:'0',body:'!magic --message public|^^tid^^|Being Slowly Digested|^^tname^^ takes another [[1d4]] HP damage from digestive juices, unless they [break free]\\lpar;!rounds ~~removetargetstatus ^^tid^^¦Ankheg-Digestion\\rpar;)}}'},
						...
						{name:'Deafness-end',type:'',ct:'0',charge:'uncharged',cost:'0',body:'!init --setmods ^^tid^^|mod|Deafness|-1||silent\n!attk --set-mods ^^tid^^|del|Surprise|Deafness\n/w "^^cname^^" ^^tname^^ has recovered from deafness and no longer suffers an initiative or surprise penalty'},
						{name:'Deafness-start',type:'',ct:'0',charge:'uncharged',cost:'0',body:'!init --setmods ^^tid^^|mod|Deafness|+1||silent\n!attk --set-mods ^^tid^^|add|Surprise|Deafness|sme+;-1\n/w "^^cname^^" ^^tname^^ has been deafened and suffers initiative and surprise penalties, as well as other effects'},
						...
						{name:'Disadvantage-Surprise-end',type:'',ct:'0',charge:'uncharged',cost:'0',body:'!attk --set-mods ^^tcid^^|del|Surprise|Manual Disadvantage\n!magic --message ^^tid^^|Disadvantage on Surprise|^^tname^^ is no longer suffering disadvantage set by the GM on rolls for Surprise. Other sources of disadvantage will still apply.'},
						{name:'Disadvantage-Surprise-start',type:'',ct:'0',charge:'uncharged',cost:'0',body:'!rounds --removetargetstatus ^^tid^^|advantage-surprise|silent\n!attk --set-mods ^^tid^^|add|Surprise|Manual Disadvantage|adsur:-1\n!magic --message ^^tid^^|Disadvantage on Surprise|^^tname^^ is suffering disadvantage on rolls for Surprise'},
						...
						{name:'Emotion-sadden-end',type:'',ct:'0',charge:'uncharged',cost:'0',body:'!init --setmods ^^tid^^|mod|Emotion-Sadden|-1||silent\n!attk --set-mods ^^tid^^|del|Surprise|Emotion-Sadden\n/w "^^cname^^" ^^tname^^ has recovered from the emotion of Sadness and no longer suffers an initiative or surprise penalty'},
						{name:'Emotion-sadden-start',type:'',ct:'0',charge:'uncharged',cost:'0',body:'!init --setmods ^^tid^^|mod|Emotion-Sadden|+1||silent\n!attk --set-mods ^^tid^^|add|Surprise|Emotion-Sadden|sme+;-1\n/w "^^cname^^" ^^tname^^ is feeling sad and suffers initiative and surprise penalties, as well as other effects'},
						...
						{name:'Foresight-caster-start',type:'',ct:'0',charge:'uncharged',cost:'0',body:'!attk --set-mods ^^tid^^|add|Foresight|Foresight|ac+:2 --set-mods ^^tid^^|add|Surprise|Foresight|sme+:10\n/w "^^cname^^" ^^tname^^\'s AC and surprise has been improved by *foresight*\n'},
						...
						{name:'Haunting-Music-end',type:'',ct:'0',charge:'uncharged',cost:'0',body:'!attk --set-mods ^^tid^^|del|Surprise|Pipes-of-Haunting'},
						{name:'Haunting-Music-start',type:'',ct:'0',charge:'uncharged',cost:'0',body:'!attk --set-mods ^^tid^^|add|Surprise|Pipes-of-Haunting|sme:-1'},
						...
						{name:'Invisible+Inaudible-end',type:'',ct:'0',charge:'uncharged',cost:'0',body:'!attk --set-mods ^^tid^^|del|Inaudibility|Invisibility\n/w "^^cname^^" Becoming visible means ^^tname^^\'s AC and saves return to normal'},
						{name:'Invisible+Inaudible-start',type:'',ct:'0',charge:'uncharged',cost:'0',body:'!attk --set-mods ^^tid^^|add|Inaudibility|Invisibility|svsav:+4 +:4 syou+;4\n/w "^^cname^^" Being invisible improves ^^tname^^\'s AC, saves and surprising others by 4'},
						{name:'Invisibility-end',type:'',ct:'0',charge:'uncharged',cost:'0',body:'!attk --set-mods ^^tid^^|del|Invisibility|Magic\n/w "^^cname^^" Becoming visible means ^^tname^^\'s AC and saves return to normal'},
						{name:'Invisibility-start',type:'',ct:'0',charge:'uncharged',cost:'0',body:'!attk --set-mods ^^tid^^|add|Invisibility|Magic|svsav:+4 +:4 syou+:2\n/w "^^cname^^" Being invisible improves ^^tname^^\'s AC and saves by 4 and chance of surprising others by 2'},
						...
						{name:'Recharge-IG-Breath-end',type:'',ct:'0',charge:'uncharged',cost:'0',body:'!magic --rest ^^tid^^|long|power|Iron-Golem-Breath --message ^^tid^^|Iron Golem Poison Cloud|The Iron Golem must breath out poison breath again'},
						...
						{name:'Silence-end',type:'',ct:'0',charge:'uncharged',cost:'0',body:'!attk --set-mods ^^tid^^|del|Surprise|Silence-15ft'},
						{name:'Silence-start',type:'',ct:'0',charge:'uncharged',cost:'0',body:'!attk --set-mods ^^tid^^|add|Surprise|Silence-15ft|syou+;2'},
						...
						{name:'Stop-All-start',type:'',ct:'0',charge:'uncharged',cost:'0',body:'!rounds --removetargetstatus ^^tid^^|disadvantage-melee|disadvantage-ranged|disadvantage-damage|disadvantage-saves|disadvantage-attributes|disadvantage-rogue|disadvantage-surprise|disadvantage-all|advantage-melee|advantage-ranged|advantage-damage|advantage-saves|advantage-attributes|advantage-rogue|advantage-surprise|advantage-all|stop-all'},
						...
						{name:'Stop-Surprise-start',type:'',ct:'0',charge:'uncharged',cost:'0',body:'!rounds --removetargetstatus ^^tid^^|disadvantage-surprise|advantage-surprise|stop-surprise'},
						...
						{name:'Surprised-end',type:'',ct:'0',charge:'uncharged',cost:'0',body:'!attk --set-mods ^^tid^^|delspell||Surprise'},
						{name:'Surprised-start',type:'',ct:'0',charge:'uncharged',cost:'0',body:'!attk --set-mods ^^tid^^|add|Frozen|Surprise|ac+:v(0;@{^^cname^^|dexdefense})||0'},
	...
	RoundMaster_Help:	{name:'RoundMaster Help',
						 ...
						 bio:'<div style="font-weight: bold; text-align: center; border-bottom: 2px solid black;">'
							...
							+'<table>'
								...
								+'<tr><th scope="row">^(... ; ... ; ...)</th><td>A \'^\' preceeding parentheses with values (which can be formulas) separated by \';\' will return the maximum of the values</td></tr>'
								+'<tr><th scope="row">v(... ; ... ; ...)</th><td>A \'v\' preceeding parentheses and \';\' separated values will return the minimum of the values</td></tr>'
...
//			log('init: calling prepareTurnorder');
	...
	var handleAdvanceTurn = function(turnorder,priororder) {
		...
		if (currentTurn) {
			...
			&& isTracker(currentTurn)) {
				...
				sendRmAPI(fields.initMaster+' --turn |'+(!_.isUndefined(priorturn) ? (priorturn.id || '') : ''));
			...
			if (!newRound) {
			    if (currentTurn.id != -1 && priororder) {
					...
					if (curToken) {
						...
						sendRmAPI(fields.initMaster+' --turn '+curToken.id+'|'+(!_.isUndefined(priorturn) ? (priorturn.id || '') : ''));
					}
				} else {
					graphic = findTrackerGraphic(); 
//					graphic.set('layer','gmlayer');
					graphic.remove();
					if (flags.rw_state === RW_StateEnum.ACTIVE) flags.rw_state = RW_StateEnum.FROZEN;
				};
			}
		}
	...
	async function doAddStatus(args,selection,senderId) {
		...
		var isGM = playerIsGM(senderId),
			...
			saveSpec = (args[5] || ''),
			silent = (saveSpec.toLowerCase() === 'silent'),
			newMarkerReason = '',
		...
		content += '</div>'; 
		updateAllTokenMarkers(); 
		if (!silent) (isGM ? sendFeedback(content) : sendResponse(senderId,content));
	};
	...
	var doResetTurnorder = function(args,isTurn=true) {
		...
		if (!turnorder) {
			...
			if(!_.find(turnorder, function(e) {
				...
				if (flags.canUseInitMaster) {
//					log('doResetTurnorder: sending --isRound');
//				    roundCtrCmd = '!init --isRound ' + initial + '|true';
				    roundCtrCmd = '!init --isRound ' + initial;
				    sendRmAPI(roundCtrCmd);
				}
        		_.each(_.keys(state.roundMaster.effects), function(e) {
        			var token = getObj('graphic',e);
...
//			log('doSort: calling prepareTurnorder');
    		prepareTurnorder(turnorder);
    		updateTurnorderMarker(turnorder);
			storeTurnorder(turnorder);
...
//		log('doTarget: curToken is '+(_.isUndefined(curToken) ? 'undefined' : 'a token'));
	...
	*/
	...
	var sendCatchError = function(apiName,msg,e,cmdStr='') {
