	...
	**/
	...
	var doMoveStatus = function(selection) {   //curToken
		...
		_.each(selection,function(e) {
			...
			if (hpField.current && hpField.current.length) hpLink = newToken.get(hpField.current.substring(0,4) + '_link');
